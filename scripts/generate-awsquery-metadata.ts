...
import type { AwsQueryServiceMeta } from "./index.ts";
...
function main() {
  ...
  const interfacePath = generateServiceInterfaces();
  console.log(`  ✅ Generated: ${path.relative(process.cwd(), interfacePath)}`);
