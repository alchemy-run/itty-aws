...
export type _MarketplaceEntitlementService = _MarketplaceEntitlementServiceClient;
export interface MarketplaceEntitlementService extends _MarketplaceEntitlementService {}
