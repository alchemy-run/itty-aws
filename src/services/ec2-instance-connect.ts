 ...
 * User Guide.
 */export const sendSSHPublicKey = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-04-02", uri: "/", method: "POST", sdkId: "EC2 Instance Connect", sigV4ServiceName: "ec2-instance-connect", name: "AWSEC2InstanceConnectService.SendSSHPublicKey" }, SendSSHPublicKeyRequest, SendSSHPublicKeyResponse, [AuthException, EC2InstanceNotFoundException, EC2InstanceStateInvalidException, EC2InstanceUnavailableException, InvalidArgsException, ServiceException, ThrottlingException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const sendSerialConsoleSSHPublicKey = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-04-02", uri: "/", method: "POST", sdkId: "EC2 Instance Connect", sigV4ServiceName: "ec2-instance-connect", name: "AWSEC2InstanceConnectService.SendSerialConsoleSSHPublicKey" }, SendSerialConsoleSSHPublicKeyRequest, SendSerialConsoleSSHPublicKeyResponse, [AuthException, EC2InstanceNotFoundException, EC2InstanceStateInvalidException, EC2InstanceTypeInvalidException, EC2InstanceUnavailableException, InvalidArgsException, SerialConsoleAccessDisabledException, SerialConsoleSessionLimitExceededException, SerialConsoleSessionUnavailableException, SerialConsoleSessionUnsupportedException, ServiceException, ThrottlingException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
