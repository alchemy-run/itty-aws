...
export type IoTFleetWiseErrors = AccessDeniedException | ConflictException | DecoderManifestValidationException | InternalServerException | InvalidNodeException | InvalidSignalsException | LimitExceededException | ResourceNotFoundException | ThrottlingException | ValidationException | CommonAwsError;
