...
export class CreateArchiveRequest extends S.Class<CreateArchiveRequest>("CreateArchiveRequest")({ArchiveName: S.String, EventSourceArn: S.String, Description: S.optional(S.String), EventPattern: S.optional(S.String), RetentionDays: S.optional(S.Number)}) {}
...
export class UpdateArchiveRequest extends S.Class<UpdateArchiveRequest>("UpdateArchiveRequest")({ArchiveName: S.String, Description: S.optional(S.String), EventPattern: S.optional(S.String), RetentionDays: S.optional(S.Number)}) {}
...
export class CreateEventBusRequest extends S.Class<CreateEventBusRequest>("CreateEventBusRequest")({Name: S.String, EventSourceName: S.optional(S.String), Tags: S.optional(TagList)}) {}
...
export class DescribeEventBusResponse extends S.Class<DescribeEventBusResponse>("DescribeEventBusResponse")({Name: S.optional(S.String), Arn: S.optional(S.String), Policy: S.optional(S.String)}) {}
...
export class RedshiftDataParameters extends S.Class<RedshiftDataParameters>("RedshiftDataParameters")({SecretManagerArn: S.optional(S.String), Database: S.String, DbUser: S.optional(S.String), Sql: S.String, StatementName: S.optional(S.String), WithEvent: S.optional(S.Boolean)}) {}
...
export class PutEventsRequest extends S.Class<PutEventsRequest>("PutEventsRequest")({Entries: PutEventsRequestEntryList}) {}
...
export class EventBus extends S.Class<EventBus>("EventBus")({Name: S.optional(S.String), Arn: S.optional(S.String), Policy: S.optional(S.String)}) {}
...
export class CreateEventBusResponse extends S.Class<CreateEventBusResponse>("CreateEventBusResponse")({EventBusArn: S.optional(S.String)}) {}
...
export class CreateConnectionRequest extends S.Class<CreateConnectionRequest>("CreateConnectionRequest")({Name: S.String, Description: S.optional(S.String), AuthorizationType: S.String, AuthParameters: CreateConnectionAuthRequestParameters}) {}
...
export class UpdateConnectionRequest extends S.Class<UpdateConnectionRequest>("UpdateConnectionRequest")({Name: S.String, Description: S.optional(S.String), AuthorizationType: S.optional(S.String), AuthParameters: S.optional(UpdateConnectionAuthRequestParameters)}) {}
 ...
 */export const deleteArchive = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.DeleteArchive" }, DeleteArchiveRequest, DeleteArchiveResponse, [ConcurrentModificationException, InternalException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const deleteEventBus = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.DeleteEventBus" }, DeleteEventBusRequest, S.Struct({}), [ConcurrentModificationException, InternalException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const disableRule = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.DisableRule" }, DisableRuleRequest, S.Struct({}), [ConcurrentModificationException, InternalException, ManagedRuleException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const enableRule = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.EnableRule" }, EnableRuleRequest, S.Struct({}), [ConcurrentModificationException, InternalException, ManagedRuleException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const removePermission = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.RemovePermission" }, RemovePermissionRequest, S.Struct({}), [ConcurrentModificationException, InternalException, OperationDisabledException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const tagResource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.TagResource" }, TagResourceRequest, TagResourceResponse, [ConcurrentModificationException, InternalException, ManagedRuleException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Removes one or more tags from the specified EventBridge resource. In Amazon EventBridge
 * (CloudWatch Events), rules and event buses can be tagged.
 */export const untagResource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.UntagResource" }, UntagResourceRequest, UntagResourceResponse, [ConcurrentModificationException, InternalException, ManagedRuleException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const deactivateEventSource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.DeactivateEventSource" }, DeactivateEventSourceRequest, S.Struct({}), [ConcurrentModificationException, InternalException, InvalidStateException, OperationDisabledException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const deauthorizeConnection = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.DeauthorizeConnection" }, DeauthorizeConnectionRequest, DeauthorizeConnectionResponse, [ConcurrentModificationException, InternalException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Deletes the specified API destination.
 */export const deleteApiDestination = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.DeleteApiDestination" }, DeleteApiDestinationRequest, DeleteApiDestinationResponse, [ConcurrentModificationException, InternalException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Deletes a connection.
 */export const deleteConnection = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.DeleteConnection" }, DeleteConnectionRequest, DeleteConnectionResponse, [ConcurrentModificationException, InternalException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const deletePartnerEventSource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.DeletePartnerEventSource" }, DeletePartnerEventSourceRequest, S.Struct({}), [ConcurrentModificationException, InternalException, OperationDisabledException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const deleteRule = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.DeleteRule" }, DeleteRuleRequest, S.Struct({}), [ConcurrentModificationException, InternalException, ManagedRuleException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Retrieves details about an API destination.
 */export const describeApiDestination = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.DescribeApiDestination" }, DescribeApiDestinationRequest, DescribeApiDestinationResponse, [InternalException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Retrieves details about an archive.
 */export const describeArchive = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.DescribeArchive" }, DescribeArchiveRequest, DescribeArchiveResponse, [InternalException, ResourceAlreadyExistsException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const describeEventBus = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.DescribeEventBus" }, DescribeEventBusRequest, DescribeEventBusResponse, [InternalException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * This operation lists details about a partner event source that is shared with your
 * account.
 */export const describeEventSource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.DescribeEventSource" }, DescribeEventSourceRequest, DescribeEventSourceResponse, [InternalException, OperationDisabledException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 * shared with them.
 */export const describePartnerEventSource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.DescribePartnerEventSource" }, DescribePartnerEventSourceRequest, DescribePartnerEventSourceResponse, [InternalException, OperationDisabledException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const describeReplay = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.DescribeReplay" }, DescribeReplayRequest, DescribeReplayResponse, [InternalException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Describes the specified rule.
 * 
 * DescribeRule does not list the targets of a rule. To see the targets associated with a
 * rule, use ListTargetsByRule.
 */export const describeRule = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.DescribeRule" }, DescribeRuleRequest, DescribeRuleResponse, [InternalException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const listRuleNamesByTarget = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.ListRuleNamesByTarget" }, ListRuleNamesByTargetRequest, ListRuleNamesByTargetResponse, [InternalException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Displays the tags associated with an EventBridge resource. In EventBridge, rules and event
 * buses can be tagged.
 */export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.ListTagsForResource" }, ListTagsForResourceRequest, ListTagsForResourceResponse, [InternalException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists the targets assigned to the specified rule.
 */export const listTargetsByRule = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.ListTargetsByRule" }, ListTargetsByRuleRequest, ListTargetsByRuleResponse, [InternalException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 * Budgets.
 */export const putRule = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.PutRule" }, PutRuleRequest, PutRuleResponse, [ConcurrentModificationException, InternalException, InvalidEventPatternException, LimitExceededException, ManagedRuleException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 * correct ARN characters when creating event patterns so that they match the ARN syntax in the
 * event you want to match.
 */export const testEventPattern = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.TestEventPattern" }, TestEventPatternRequest, TestEventPatternResponse, [InternalException, InvalidEventPatternException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Updates an API destination.
 */export const updateApiDestination = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.UpdateApiDestination" }, UpdateApiDestinationRequest, UpdateApiDestinationResponse, [ConcurrentModificationException, InternalException, LimitExceededException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Updates the specified archive.
 */export const updateArchive = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.UpdateArchive" }, UpdateArchiveRequest, UpdateArchiveResponse, [ConcurrentModificationException, InternalException, InvalidEventPatternException, LimitExceededException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const activateEventSource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.ActivateEventSource" }, ActivateEventSourceRequest, S.Struct({}), [ConcurrentModificationException, InternalException, InvalidStateException, OperationDisabledException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Cancels the specified replay.
 */export const cancelReplay = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.CancelReplay" }, CancelReplayRequest, CancelReplayResponse, [ConcurrentModificationException, IllegalStatusException, InternalException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Creates an API destination, which is an HTTP invocation endpoint configured as a target
 * for events.
 */export const createApiDestination = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.CreateApiDestination" }, CreateApiDestinationRequest, CreateApiDestinationResponse, [InternalException, LimitExceededException, ResourceAlreadyExistsException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 * sent to an archive.
 */export const createArchive = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.CreateArchive" }, CreateArchiveRequest, CreateArchiveResponse, [ConcurrentModificationException, InternalException, InvalidEventPatternException, LimitExceededException, ResourceAlreadyExistsException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const createEventBus = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.CreateEventBus" }, CreateEventBusRequest, CreateEventBusResponse, [ConcurrentModificationException, InternalException, InvalidStateException, LimitExceededException, OperationDisabledException, ResourceAlreadyExistsException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const createPartnerEventSource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.CreatePartnerEventSource" }, CreatePartnerEventSourceRequest, CreatePartnerEventSourceResponse, [ConcurrentModificationException, InternalException, LimitExceededException, OperationDisabledException, ResourceAlreadyExistsException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Retrieves a list of API destination in the account in the current Region.
 */export const listApiDestinations = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.ListApiDestinations" }, ListApiDestinationsRequest, ListApiDestinationsResponse, [InternalException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const listArchives = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.ListArchives" }, ListArchivesRequest, ListArchivesResponse, [InternalException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Retrieves a list of connections from the account.
 */export const listConnections = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.ListConnections" }, ListConnectionsRequest, ListConnectionsResponse, [InternalException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists all the event buses in your account, including the default event bus, custom event
 * buses, and partner event buses.
 */export const listEventBuses = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.ListEventBuses" }, ListEventBusesRequest, ListEventBusesResponse, [InternalException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const listEventSources = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.ListEventSources" }, ListEventSourcesRequest, ListEventSourcesResponse, [InternalException, OperationDisabledException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 * customers.
 */export const listPartnerEventSourceAccounts = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.ListPartnerEventSourceAccounts" }, ListPartnerEventSourceAccountsRequest, ListPartnerEventSourceAccountsResponse, [InternalException, OperationDisabledException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const listPartnerEventSources = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.ListPartnerEventSources" }, ListPartnerEventSourcesRequest, ListPartnerEventSourcesResponse, [InternalException, OperationDisabledException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const listReplays = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.ListReplays" }, ListReplaysRequest, ListReplaysResponse, [InternalException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const listRules = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.ListRules" }, ListRulesRequest, ListRulesResponse, [InternalException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const putPermission = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.PutPermission" }, PutPermissionRequest, S.Struct({}), [ConcurrentModificationException, InternalException, OperationDisabledException, PolicyLengthExceededException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const removeTargets = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.RemoveTargets" }, RemoveTargetsRequest, RemoveTargetsResponse, [ConcurrentModificationException, InternalException, ManagedRuleException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 * replayed.
 */export const startReplay = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.StartReplay" }, StartReplayRequest, StartReplayResponse, [InternalException, InvalidEventPatternException, LimitExceededException, ResourceAlreadyExistsException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Sends custom events to Amazon EventBridge so that they can be matched to rules.
 */export const putEvents = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.PutEvents" }, PutEventsRequest, PutEventsResponse, [InternalException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const putPartnerEvents = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.PutPartnerEvents" }, PutPartnerEventsRequest, PutPartnerEventsResponse, [InternalException, OperationDisabledException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const createConnection = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.CreateConnection" }, CreateConnectionRequest, CreateConnectionResponse, [InternalException, LimitExceededException, ResourceAlreadyExistsException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Retrieves details about a connection.
 */export const describeConnection = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.DescribeConnection" }, DescribeConnectionRequest, DescribeConnectionResponse, [InternalException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Updates settings for a connection.
 */export const updateConnection = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.UpdateConnection" }, UpdateConnectionRequest, UpdateConnectionResponse, [ConcurrentModificationException, InternalException, LimitExceededException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 * happens, `FailedEntryCount` is non-zero in the response and each entry in
 * `FailedEntries` provides the ID of the failed target and the error code.
 */export const putTargets = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", sdkId: "CloudWatch Events", sigV4ServiceName: "events", name: "AWSEvents.PutTargets" }, PutTargetsRequest, PutTargetsResponse, [ConcurrentModificationException, InternalException, LimitExceededException, ManagedRuleException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
