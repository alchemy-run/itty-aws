...
export type SecretsManagerErrors = DecryptionFailure | EncryptionFailure | InternalServiceError | InvalidNextTokenException | InvalidParameterException | InvalidRequestException | LimitExceededException | MalformedPolicyDocumentException | PreconditionNotMetException | PublicPolicyException | ResourceExistsException | ResourceNotFoundException | CommonAwsError;
