...
const metadata = {
  ...
  operations: {
    "ListManagedNotificationChannelAssociations": "GET /channels/list-managed-notification-channel-associations",
    ...
    "AssociateManagedNotificationAccountContact": "PUT /contacts/associate-managed-notification/{contactIdentifier}",
    "AssociateManagedNotificationAdditionalChannel": "PUT /channels/associate-managed-notification/{channelArn}",
    "AssociateOrganizationalUnit": "POST /organizational-units/associate/{organizationalUnitId}",
    ...
    "DeleteNotificationConfiguration": "DELETE /notification-configurations/{arn}",
    "DeregisterNotificationHub": "DELETE /notification-hubs/{notificationHubRegion}",
    "DisableNotificationsAccessForOrganization": "DELETE /organization/access",
    "DisassociateChannel": "POST /channels/disassociate/{arn}",
    "DisassociateManagedNotificationAccountContact": "PUT /contacts/disassociate-managed-notification/{contactIdentifier}",
    "DisassociateManagedNotificationAdditionalChannel": "PUT /channels/disassociate-managed-notification/{channelArn}",
    "DisassociateOrganizationalUnit": "POST /organizational-units/disassociate/{organizationalUnitId}",
    "EnableNotificationsAccessForOrganization": "POST /organization/access",
    "GetEventRule": "GET /event-rules/{arn}",
    "GetManagedNotificationChildEvent": "GET /managed-notification-child-events/{arn}",
    "GetManagedNotificationConfiguration": "GET /managed-notification-configurations/{arn}",
    ...
    "ListManagedNotificationChildEvents": "GET /list-managed-notification-child-events/{aggregateManagedNotificationEventArn}",
