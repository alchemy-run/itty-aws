 ...
 */export const invokeEndpoint = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-05-13", uri: "/endpoints/{EndpointName}/invocations", sdkId: "SageMaker Runtime", sigV4ServiceName: "sagemaker", name: "AmazonSageMakerRuntime.InvokeEndpoint" }, InvokeEndpointInput, InvokeEndpointOutput, [InternalDependencyException, InternalFailure, ModelError, ModelNotReadyException, ServiceUnavailable, ValidationError]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * After you deploy a model into production using Amazon SageMaker AI hosting services,
 * your client applications use this API to get inferences from the model hosted at the
