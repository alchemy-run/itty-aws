...
export type PersonalizeErrors = InvalidInputException | InvalidNextTokenException | LimitExceededException | ResourceAlreadyExistsException | ResourceInUseException | ResourceNotFoundException | TooManyTagKeysException | TooManyTagsException | CommonAwsError;
