...
export type StartReplicationMigrationTypeValue = "reload-target" | "resume-processing" | "start-replication";
...
export type TablePreparationMode = "do-nothing" | "truncate" | "drop-tables-on-target";
