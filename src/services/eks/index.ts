...
const metadata = {
  ...
  endpointPrefix: "eks",
  operations: {
    "AssociateAccessPolicy": "POST /clusters/{clusterName}/access-entries/{principalArn}/access-policies",
    "AssociateEncryptionConfig": "POST /clusters/{clusterName}/encryption-config/associate",
    "AssociateIdentityProviderConfig": "POST /clusters/{clusterName}/identity-provider-configs/associate",
    ...
    "CreatePodIdentityAssociation": "POST /clusters/{clusterName}/pod-identity-associations",
    "DeleteAccessEntry": "DELETE /clusters/{clusterName}/access-entries/{principalArn}",
    ...
    "DeletePodIdentityAssociation": "DELETE /clusters/{clusterName}/pod-identity-associations/{associationId}",
    "DeregisterCluster": "DELETE /cluster-registrations/{name}",
    "DescribeAccessEntry": "GET /clusters/{clusterName}/access-entries/{principalArn}",
    ...
    "DescribeFargateProfile": "GET /clusters/{clusterName}/fargate-profiles/{fargateProfileName}",
    "DescribeIdentityProviderConfig": "POST /clusters/{clusterName}/identity-provider-configs/describe",
    "DescribeInsight": "GET /clusters/{clusterName}/insights/{id}",
    "DescribeNodegroup": "GET /clusters/{clusterName}/node-groups/{nodegroupName}",
    "DescribePodIdentityAssociation": "GET /clusters/{clusterName}/pod-identity-associations/{associationId}",
    "DescribeUpdate": "GET /clusters/{name}/updates/{updateId}",
    "DisassociateAccessPolicy": "DELETE /clusters/{clusterName}/access-entries/{principalArn}/access-policies/{policyArn}",
    "DisassociateIdentityProviderConfig": "POST /clusters/{clusterName}/identity-provider-configs/disassociate",
    ...
    "ListAssociatedAccessPolicies": "GET /clusters/{clusterName}/access-entries/{principalArn}/access-policies",
    ...
    "ListIdentityProviderConfigs": "GET /clusters/{clusterName}/identity-provider-configs",
    "ListInsights": "POST /clusters/{clusterName}/insights",
    "ListNodegroups": "GET /clusters/{clusterName}/node-groups",
    "ListPodIdentityAssociations": "GET /clusters/{clusterName}/pod-identity-associations",
    "ListTagsForResource": "GET /tags/{resourceArn}",
    "ListUpdates": "GET /clusters/{name}/updates",
    "RegisterCluster": "POST /cluster-registrations",
    "TagResource": "POST /tags/{resourceArn}",
    "UntagResource": "DELETE /tags/{resourceArn}",
    "UpdateAccessEntry": "POST /clusters/{clusterName}/access-entries/{principalArn}",
    ...
    "UpdateNodegroupConfig": "POST /clusters/{clusterName}/node-groups/{nodegroupName}/update-config",
    "UpdateNodegroupVersion": "POST /clusters/{clusterName}/node-groups/{nodegroupName}/update-version",
    "UpdatePodIdentityAssociation": "POST /clusters/{clusterName}/pod-identity-associations/{associationId}",
  },
