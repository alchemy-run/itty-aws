...
export type LicenseManagerLinuxSubscriptionsErrors = InternalServerException | ResourceNotFoundException | ThrottlingException | ValidationException | CommonAwsError;
