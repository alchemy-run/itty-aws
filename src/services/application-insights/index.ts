...
import type { ApplicationInsights as _ApplicationInsightsClient } from "./types.ts";
...
const metadata = {
  ...
  version: "2018-11-25",
  protocol: "awsJson1_1",
  sigV4ServiceName: "applicationinsights",
...
} as unknown as typeof _ApplicationInsightsClient;
