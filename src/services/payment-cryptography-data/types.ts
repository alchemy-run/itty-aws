...
export type IncomingKeyMaterial = (_IncomingKeyMaterial & { DiffieHellmanTr31KeyBlock: IncomingDiffieHellmanTr31KeyBlock });
...
export type PinBlockFormatForPinData = "ISO_FORMAT_0" | "ISO_FORMAT_1" | "ISO_FORMAT_3" | "ISO_FORMAT_4";
...
export type PaymentCryptographyDataErrors = AccessDeniedException | InternalServerException | ResourceNotFoundException | ThrottlingException | ValidationException | VerificationFailedException | CommonAwsError;
