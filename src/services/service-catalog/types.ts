...
export interface CopyProductInput {
  ...
  SourceProvisioningArtifactIdentifiers?: Array<{ [key in ProvisioningArtifactPropertyName]?: string }>;
...
export type ServiceActionAssociationErrorCode = "DUPLICATE_RESOURCE" | "INTERNAL_FAILURE" | "LIMIT_EXCEEDED" | "RESOURCE_NOT_FOUND" | "THROTTLING" | "INVALID_PARAMETER";
...
export type SourceProvisioningArtifactProperties = Array<{ [key in ProvisioningArtifactPropertyName]?: string }>;
...
export type ServiceCatalogErrors = DuplicateResourceException | InvalidParametersException | InvalidStateException | LimitExceededException | OperationNotSupportedException | ResourceInUseException | ResourceNotFoundException | TagOptionNotMigratedException | CommonAwsError;
