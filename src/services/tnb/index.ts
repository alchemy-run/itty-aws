...
const metadata = {
  ...
  operations: {
    "CancelSolNetworkOperation": "POST /sol/nslcm/v1/ns_lcm_op_occs/{nsLcmOpOccId}/cancel",
    ...
    "DeleteSolNetworkInstance": "DELETE /sol/nslcm/v1/ns_instances/{nsInstanceId}",
    ...
    "InstantiateSolNetworkInstance": "POST /sol/nslcm/v1/ns_instances/{nsInstanceId}/instantiate",
    ...
    "PutSolFunctionPackageContent": "PUT /sol/vnfpkgm/v1/vnf_packages/{vnfPkgId}/package_content",
    "PutSolNetworkPackageContent": "PUT /sol/nsd/v1/ns_descriptors/{nsdInfoId}/nsd_content",
    "TagResource": "POST /tags/{resourceArn}",
    "TerminateSolNetworkInstance": "POST /sol/nslcm/v1/ns_instances/{nsInstanceId}/terminate",
    "UntagResource": "DELETE /tags/{resourceArn}",
    "UpdateSolFunctionPackage": "PATCH /sol/vnfpkgm/v1/vnf_packages/{vnfPkgId}",
    "UpdateSolNetworkInstance": "POST /sol/nslcm/v1/ns_instances/{nsInstanceId}/update",
    "UpdateSolNetworkPackage": "PATCH /sol/nsd/v1/ns_descriptors/{nsdInfoId}",
    "ValidateSolFunctionPackageContent": "PUT /sol/vnfpkgm/v1/vnf_packages/{vnfPkgId}/package_content/validate",
    "ValidateSolNetworkPackageContent": "PUT /sol/nsd/v1/ns_descriptors/{nsdInfoId}/nsd_content/validate",
  },
