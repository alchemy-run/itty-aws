...
import type { Invoicing as _InvoicingClient } from "./types.ts";
...
export type _Invoicing = _InvoicingClient;
export interface Invoicing extends _Invoicing {}
...
} as unknown as typeof _InvoicingClient;
