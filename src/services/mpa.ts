 ...
 */export const getResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2022-07-26", uri: "/GetResourcePolicy", sdkId: "MPA", sigV4ServiceName: "mpa", name: "AWSFluffyCoreService.GetResourcePolicy" }, GetResourcePolicyRequest, GetResourcePolicyResponse, [AccessDeniedException, InvalidParameterException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Returns a list of policies. Policies define the permissions for team resources.
 * 
 * The protected operation for a service integration might require specific permissions. For more information, see How other services work with Multi-party approval in the *Multi-party approval User Guide*.
 */export const listPolicies = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2022-07-26", uri: "/policies/?List", sdkId: "MPA", sigV4ServiceName: "mpa", name: "AWSFluffyCoreService.ListPolicies" }, ListPoliciesRequest, ListPoliciesResponse, [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Returns a list of the versions for policies. Policies define the permissions for team resources.
 * 
 * The protected operation for a service integration might require specific permissions. For more information, see How other services work with Multi-party approval in the *Multi-party approval User Guide*.
 */export const listPolicyVersions = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2022-07-26", uri: "/policies/{PolicyArn}/?List", sdkId: "MPA", sigV4ServiceName: "mpa", name: "AWSFluffyCoreService.ListPolicyVersions" }, ListPolicyVersionsRequest, ListPolicyVersionsResponse, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Returns a list of policies for a resource.
 */export const listResourcePolicies = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2022-07-26", uri: "/resource-policies/{ResourceArn}/?List", sdkId: "MPA", sigV4ServiceName: "mpa", name: "AWSFluffyCoreService.ListResourcePolicies" }, ListResourcePoliciesRequest, ListResourcePoliciesResponse, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
