...
export type ClusterStatus = "CREATING" | "UPDATING" | "DELETING" | "AVAILABLE" | "FAILED" | "DELETED" | "MAINTENANCE";
...
export type DurationType = "hours" | "minutes" | "seconds" | "milliseconds" | "days";
export type EngineType = "INFLUXDB_V2" | "INFLUXDB_V3_CORE" | "INFLUXDB_V3_ENTERPRISE";
...
export type InstanceMode = "PRIMARY" | "STANDBY" | "REPLICA" | "INGEST" | "QUERY" | "COMPACT" | "PROCESS";
...
export type Parameters = (_Parameters & { InfluxDBv2: InfluxDBv2Parameters }) | (_Parameters & { InfluxDBv3Core: InfluxDBv3CoreParameters }) | (_Parameters & { InfluxDBv3Enterprise: InfluxDBv3EnterpriseParameters });
...
export type PercentOrAbsoluteLong = (_PercentOrAbsoluteLong & { percent: string }) | (_PercentOrAbsoluteLong & { absolute: number });
...
export type Status = "CREATING" | "AVAILABLE" | "DELETING" | "MODIFYING" | "UPDATING" | "DELETED" | "FAILED" | "UPDATING_DEPLOYMENT_TYPE" | "UPDATING_INSTANCE_TYPE" | "MAINTENANCE";
...
export type TimestreamInfluxDBErrors = AccessDeniedException | ConflictException | InternalServerException | ResourceNotFoundException | ServiceQuotaExceededException | ThrottlingException | ValidationException | CommonAwsError;
