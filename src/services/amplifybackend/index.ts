...
const metadata = {
  ...
  operations: {
    "CloneBackend": "POST /backend/{AppId}/environments/{BackendEnvironmentName}/clone",
    ...
    "DeleteBackend": "POST /backend/{AppId}/environments/{BackendEnvironmentName}/remove",
    "DeleteBackendAPI": "POST /backend/{AppId}/api/{BackendEnvironmentName}/remove",
    "DeleteBackendAuth": "POST /backend/{AppId}/auth/{BackendEnvironmentName}/remove",
    "DeleteBackendStorage": "POST /backend/{AppId}/storage/{BackendEnvironmentName}/remove",
    "DeleteToken": "POST /backend/{AppId}/challenge/{SessionId}/remove",
    "GenerateBackendAPIModels": "POST /backend/{AppId}/api/{BackendEnvironmentName}/generateModels",
    "GetBackend": "POST /backend/{AppId}/details",
    "GetBackendAPI": "POST /backend/{AppId}/api/{BackendEnvironmentName}/details",
    "GetBackendAPIModels": "POST /backend/{AppId}/api/{BackendEnvironmentName}/getModels",
    "GetBackendAuth": "POST /backend/{AppId}/auth/{BackendEnvironmentName}/details",
    "GetBackendJob": "GET /backend/{AppId}/job/{BackendEnvironmentName}/{JobId}",
    "GetBackendStorage": "POST /backend/{AppId}/storage/{BackendEnvironmentName}/details",
    "GetToken": "GET /backend/{AppId}/challenge/{SessionId}",
    "ImportBackendAuth": "POST /backend/{AppId}/auth/{BackendEnvironmentName}/import",
    "ImportBackendStorage": "POST /backend/{AppId}/storage/{BackendEnvironmentName}/import",
    ...
    "UpdateBackendJob": "POST /backend/{AppId}/job/{BackendEnvironmentName}/{JobId}",
    "UpdateBackendStorage": "POST /backend/{AppId}/storage/{BackendEnvironmentName}",
  },
