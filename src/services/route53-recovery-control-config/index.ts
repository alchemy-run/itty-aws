...
const metadata = {
  ...
  operations: {
    ...
    "ListAssociatedRoute53HealthChecks": "GET /routingcontrol/{RoutingControlArn}/associatedRoute53HealthChecks",
...
export interface Route53RecoveryControlConfig extends _Route53RecoveryControlConfig {}
