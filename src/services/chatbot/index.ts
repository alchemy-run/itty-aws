...
const metadata = {
  ...
  operations: {
    ...
    "CreateMicrosoftTeamsChannelConfiguration": "POST /create-ms-teams-channel-configuration",
    ...
    "DeleteMicrosoftTeamsChannelConfiguration": "POST /delete-ms-teams-channel-configuration",
    "DeleteMicrosoftTeamsConfiguredTeam": "POST /delete-ms-teams-configured-teams",
    ...
    "DescribeChimeWebhookConfigurations": "POST /describe-chime-webhook-configurations",
    "DescribeSlackChannelConfigurations": "POST /describe-slack-channel-configurations",
    ...
    "GetMicrosoftTeamsChannelConfiguration": "POST /get-ms-teams-channel-configuration",
    "ListAssociations": "POST /list-associations",
    "ListMicrosoftTeamsChannelConfigurations": "POST /list-ms-teams-channel-configurations",
    ...
    "UpdateMicrosoftTeamsChannelConfiguration": "POST /update-ms-teams-channel-configuration",
