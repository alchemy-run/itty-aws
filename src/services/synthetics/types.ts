...
export type syntheticsErrors = AccessDeniedException | BadRequestException | ConflictException | InternalFailureException | InternalServerException | NotFoundException | RequestEntityTooLargeException | ResourceNotFoundException | ServiceQuotaExceededException | TooManyRequestsException | ValidationException | CommonAwsError;
