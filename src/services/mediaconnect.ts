 ...
 */export const tagGlobalResource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-11-14", uri: "/tags/global/{ResourceArn}", sdkId: "MediaConnect", sigV4ServiceName: "mediaconnect", name: "MediaConnect.TagGlobalResource" }, TagGlobalResourceRequest, S.Struct({}), [BadRequestException, InternalServerErrorException, NotFoundException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const tagResource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-11-14", uri: "/tags/{ResourceArn}", sdkId: "MediaConnect", sigV4ServiceName: "mediaconnect", name: "MediaConnect.TagResource" }, TagResourceRequest, S.Struct({}), [BadRequestException, InternalServerErrorException, NotFoundException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
