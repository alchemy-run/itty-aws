...
const metadata = {
  ...
  operations: {
    ...
    "CreateKxChangeset": "POST /kx/environments/{environmentId}/databases/{databaseName}/changesets",
    ...
    "DeleteKxCluster": "DELETE /kx/environments/{environmentId}/clusters/{clusterName}",
    "DeleteKxClusterNode": "DELETE /kx/environments/{environmentId}/clusters/{clusterName}/nodes/{nodeId}",
    "DeleteKxDatabase": "DELETE /kx/environments/{environmentId}/databases/{databaseName}",
    "DeleteKxDataview": "DELETE /kx/environments/{environmentId}/databases/{databaseName}/dataviews/{dataviewName}",
    ...
    "DeleteKxVolume": "DELETE /kx/environments/{environmentId}/kxvolumes/{volumeName}",
    "GetEnvironment": "GET /environment/{environmentId}",
    "GetKxChangeset": "GET /kx/environments/{environmentId}/databases/{databaseName}/changesets/{changesetId}",
    "GetKxCluster": "GET /kx/environments/{environmentId}/clusters/{clusterName}",
    "GetKxConnectionString": "GET /kx/environments/{environmentId}/connectionString",
    "GetKxDatabase": "GET /kx/environments/{environmentId}/databases/{databaseName}",
    "GetKxDataview": "GET /kx/environments/{environmentId}/databases/{databaseName}/dataviews/{dataviewName}",
    ...
    "ListKxChangesets": "GET /kx/environments/{environmentId}/databases/{databaseName}/changesets",
    "ListKxClusterNodes": "GET /kx/environments/{environmentId}/clusters/{clusterName}/nodes",
    ...
    "UpdateKxClusterCodeConfiguration": "PUT /kx/environments/{environmentId}/clusters/{clusterName}/configuration/code",
    "UpdateKxClusterDatabases": "PUT /kx/environments/{environmentId}/clusters/{clusterName}/configuration/databases",
    "UpdateKxDatabase": "PUT /kx/environments/{environmentId}/databases/{databaseName}",
    "UpdateKxDataview": "PUT /kx/environments/{environmentId}/databases/{databaseName}/dataviews/{dataviewName}",
    ...
    "UpdateKxVolume": "PATCH /kx/environments/{environmentId}/kxvolumes/{volumeName}",
  },
