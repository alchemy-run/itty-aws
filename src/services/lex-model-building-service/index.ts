...
const metadata = {
  ...
  operations: {
    ...
    "DeleteBotChannelAssociation": "DELETE /bots/{botName}/aliases/{botAlias}/channels/{name}",
    ...
    "GetBotChannelAssociation": "GET /bots/{botName}/aliases/{botAlias}/channels/{name}",
    "GetBotChannelAssociations": "GET /bots/{botName}/aliases/{botAlias}/channels",
    "GetBots": "GET /bots",
