 ...
 */export const describeReportDefinitions = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-01-06", sdkId: "Cost and Usage Report Service", sigV4ServiceName: "cur", name: "AWSOrigamiServiceGatewayService.DescribeReportDefinitions" }, DescribeReportDefinitionsRequest, DescribeReportDefinitionsResponse, [InternalErrorException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists the tags associated with the specified report definition.
 */export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-01-06", sdkId: "Cost and Usage Report Service", sigV4ServiceName: "cur", name: "AWSOrigamiServiceGatewayService.ListTagsForResource" }, ListTagsForResourceRequest, ListTagsForResourceResponse, [InternalErrorException, ResourceNotFoundException, ValidationException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Associates a set of tags with a report definition.
 */export const tagResource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-01-06", sdkId: "Cost and Usage Report Service", sigV4ServiceName: "cur", name: "AWSOrigamiServiceGatewayService.TagResource" }, TagResourceRequest, TagResourceResponse, [InternalErrorException, ResourceNotFoundException, ValidationException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Disassociates a set of tags from a report definition.
 */export const untagResource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-01-06", sdkId: "Cost and Usage Report Service", sigV4ServiceName: "cur", name: "AWSOrigamiServiceGatewayService.UntagResource" }, UntagResourceRequest, UntagResourceResponse, [InternalErrorException, ResourceNotFoundException, ValidationException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Deletes the specified report. Any tags associated with the report are also
 * deleted.
 */export const deleteReportDefinition = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-01-06", sdkId: "Cost and Usage Report Service", sigV4ServiceName: "cur", name: "AWSOrigamiServiceGatewayService.DeleteReportDefinition" }, DeleteReportDefinitionRequest, DeleteReportDefinitionResponse, [InternalErrorException, ValidationException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Allows you to programmatically update your report preferences.
 */export const modifyReportDefinition = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-01-06", sdkId: "Cost and Usage Report Service", sigV4ServiceName: "cur", name: "AWSOrigamiServiceGatewayService.ModifyReportDefinition" }, ModifyReportDefinitionRequest, ModifyReportDefinitionResponse, [InternalErrorException, ValidationException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Creates a new report using the description that you provide.
 */export const putReportDefinition = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-01-06", sdkId: "Cost and Usage Report Service", sigV4ServiceName: "cur", name: "AWSOrigamiServiceGatewayService.PutReportDefinition" }, PutReportDefinitionRequest, PutReportDefinitionResponse, [DuplicateReportNameException, InternalErrorException, ReportLimitReachedException, ResourceNotFoundException, ValidationException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
