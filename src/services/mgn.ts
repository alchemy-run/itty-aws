 ...
 */export const untagResource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2020-02-26", uri: "/tags/{resourceArn}", method: "DELETE", sdkId: "mgn", sigV4ServiceName: "mgn", name: "ApplicationMigrationService.UntagResource" }, UntagResourceRequest, S.Struct({}), [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Initialize Application Migration Service.
 */export const initializeService = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2020-02-26", uri: "/InitializeService", sdkId: "mgn", sigV4ServiceName: "mgn", name: "ApplicationMigrationService.InitializeService" }, InitializeServiceRequest, InitializeServiceResponse, [AccessDeniedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * List all tags for your Application Migration Service resources.
 */export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2020-02-26", uri: "/tags/{resourceArn}", method: "GET", sdkId: "mgn", sigV4ServiceName: "mgn", name: "ApplicationMigrationService.ListTagsForResource" }, ListTagsForResourceRequest, ListTagsForResourceResponse, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Adds or overwrites only the specified tags for the specified Application Migration Service resource or resources. When you specify an existing tag key, the value is overwritten with the new value. Each resource can have a maximum of 50 tags. Each tag consists of a key and optional value.
 */export const tagResource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2020-02-26", uri: "/tags/{resourceArn}", sdkId: "mgn", sigV4ServiceName: "mgn", name: "ApplicationMigrationService.TagResource" }, TagResourceRequest, S.Struct({}), [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * List Managed Accounts.
 */export const listManagedAccounts = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2020-02-26", uri: "/ListManagedAccounts", sdkId: "mgn", sigV4ServiceName: "mgn", name: "ApplicationMigrationService.ListManagedAccounts" }, ListManagedAccountsRequest, ListManagedAccountsResponse, [UninitializedAccountException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
