 ...
 */export const updateTraceSegmentDestination = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2016-04-12", uri: "/UpdateTraceSegmentDestination", sdkId: "XRay", sigV4ServiceName: "xray", name: "AWSXRay.UpdateTraceSegmentDestination" }, UpdateTraceSegmentDestinationRequest, UpdateTraceSegmentDestinationResult, [InvalidRequestException, ThrottledException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Creates a group resource with a name and a filter expression.
 */export const createGroup = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2016-04-12", uri: "/CreateGroup", sdkId: "XRay", sigV4ServiceName: "xray", name: "AWSXRay.CreateGroup" }, CreateGroupRequest, CreateGroupResult, [InvalidRequestException, ThrottledException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Deletes a sampling rule.
 */export const deleteSamplingRule = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2016-04-12", uri: "/DeleteSamplingRule", sdkId: "XRay", sigV4ServiceName: "xray", name: "AWSXRay.DeleteSamplingRule" }, DeleteSamplingRuleRequest, DeleteSamplingRuleResult, [InvalidRequestException, ThrottledException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Retrieves group resource details.
 */export const getGroup = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2016-04-12", uri: "/GetGroup", sdkId: "XRay", sigV4ServiceName: "xray", name: "AWSXRay.GetGroup" }, GetGroupRequest, GetGroupResult, [InvalidRequestException, ThrottledException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Retrieves all active group details.
 */export const getGroups = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2016-04-12", uri: "/Groups", sdkId: "XRay", sigV4ServiceName: "xray", name: "AWSXRay.GetGroups" }, GetGroupsRequest, GetGroupsResult, [InvalidRequestException, ThrottledException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const getInsight = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2016-04-12", uri: "/Insight", sdkId: "XRay", sigV4ServiceName: "xray", name: "AWSXRay.GetInsight" }, GetInsightRequest, GetInsightResult, [InvalidRequestException, ThrottledException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
