...
export type ConnectorEgressConfig = (_ConnectorEgressConfig & { VpcLattice: ConnectorVpcLatticeEgressConfig });
...
export type DescribedConnectorEgressConfig = (_DescribedConnectorEgressConfig & { VpcLattice: DescribedConnectorVpcLatticeEgressConfig });
...
export type UpdateConnectorEgressConfig = (_UpdateConnectorEgressConfig & { VpcLattice: UpdateConnectorVpcLatticeEgressConfig });
...
export type TransferErrors = AccessDeniedException | ConflictException | InternalServiceError | InvalidNextTokenException | InvalidRequestException | ResourceExistsException | ResourceNotFoundException | ServiceUnavailableException | ThrottlingException | CommonAwsError;
