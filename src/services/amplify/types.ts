...
export type AmplifyErrors = BadRequestException | DependentServiceFailureException | InternalFailureException | LimitExceededException | NotFoundException | ResourceNotFoundException | UnauthorizedException | CommonAwsError;
