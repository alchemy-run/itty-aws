...
export type codestarnotificationsErrors = AccessDeniedException | ConcurrentModificationException | ConfigurationException | InvalidNextTokenException | LimitExceededException | ResourceAlreadyExistsException | ResourceNotFoundException | ValidationException | CommonAwsError;
