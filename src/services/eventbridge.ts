 ...
 * *Amazon EventBridge User Guide*
 * .
 */export const listEndpoints = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", uri: "/", method: "POST", sdkId: "EventBridge", sigV4ServiceName: "events", name: "AWSEvents.ListEndpoints" }, ListEndpointsRequest, ListEndpointsResponse, [InternalException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists all the event buses in your account, including the default event bus, custom event
 * buses, and partner event buses.
 */export const listEventBuses = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", uri: "/", method: "POST", sdkId: "EventBridge", sigV4ServiceName: "events", name: "AWSEvents.ListEventBuses" }, ListEventBusesRequest, ListEventBusesResponse, [InternalException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const listReplays = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", uri: "/", method: "POST", sdkId: "EventBridge", sigV4ServiceName: "events", name: "AWSEvents.ListReplays" }, ListReplaysRequest, ListReplaysResponse, [InternalException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const putEvents = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2015-10-07", uri: "/", method: "POST", sdkId: "EventBridge", sigV4ServiceName: "events", name: "AWSEvents.PutEvents" }, PutEventsRequest, PutEventsResponse, [InternalException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
