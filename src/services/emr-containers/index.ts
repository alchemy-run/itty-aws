...
const metadata = {
  ...
  operations: {
    ...
    "DeleteManagedEndpoint": "DELETE /virtualclusters/{virtualClusterId}/endpoints/{id}",
    ...
    "DescribeManagedEndpoint": "GET /virtualclusters/{virtualClusterId}/endpoints/{id}",
    "DescribeSecurityConfiguration": "GET /securityconfigurations/{id}",
    "DescribeVirtualCluster": "GET /virtualclusters/{id}",
    "GetManagedEndpointSessionCredentials": "POST /virtualclusters/{virtualClusterIdentifier}/endpoints/{endpointIdentifier}/credentials",
