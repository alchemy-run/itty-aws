...
export type OmicsErrors = AccessDeniedException | ConflictException | InternalServerException | NotSupportedOperationException | RangeNotSatisfiableException | RequestTimeoutException | ResourceNotFoundException | ServiceQuotaExceededException | ThrottlingException | ValidationException | CommonAwsError;
