 ...
 */export const createOAuth2Token = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-01-01", uri: "/v1/token", sdkId: "Signin", sigV4ServiceName: "signin", name: "Signin.CreateOAuth2Token" }, CreateOAuth2TokenRequest, CreateOAuth2TokenResponse, [AccessDeniedException, InternalServerException, TooManyRequestsError, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
