...
export type AuthorizationStrategy = "SMART_ON_FHIR_V1" | "SMART_ON_FHIR" | "AWS_AUTH";
...
export type HealthLakeErrors = AccessDeniedException | ConflictException | InternalServerException | ResourceNotFoundException | ThrottlingException | ValidationException | CommonAwsError;
