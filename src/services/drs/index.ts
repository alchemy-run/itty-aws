...
const metadata = {
  ...
  operations: {
    ...
    "GetFailbackReplicationConfiguration": "POST /GetFailbackReplicationConfiguration",
    ...
    "UpdateFailbackReplicationConfiguration": "POST /UpdateFailbackReplicationConfiguration",
