...
const metadata = {
  ...
  operations: {
    ...
    "BatchDisassociateCodeSecurityScanConfiguration": "POST /codesecurity/scan-configuration/batch/disassociate",
    ...
    "ListCodeSecurityScanConfigurationAssociations": "POST /codesecurity/scan-configuration/associations/list",
