...
export declare class WAFV2 extends AWSServiceClient {
  associateWebACL(
    ...
    WAFInternalErrorException | WAFInvalidOperationException | WAFInvalidParameterException | WAFLimitsExceededException | WAFNonexistentItemException | WAFUnavailableEntityException | CommonAwsError
  >;
  checkCapacity(
...
export type ResourceType = "APPLICATION_LOAD_BALANCER" | "API_GATEWAY" | "APPSYNC" | "COGNITO_USER_POOL" | "APP_RUNNER_SERVICE" | "VERIFIED_ACCESS_INSTANCE" | "AMPLIFY";
