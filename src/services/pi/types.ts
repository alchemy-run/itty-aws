...
export type FineGrainedAction = "DescribeDimensionKeys" | "GetDimensionKeyDetails" | "GetResourceMetrics";
...
export type PIErrors = InternalServiceError | InvalidArgumentException | NotAuthorizedException | CommonAwsError;
