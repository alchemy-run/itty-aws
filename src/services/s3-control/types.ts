...
export type ComputeObjectChecksumAlgorithm = "CRC32" | "CRC32C" | "CRC64NVME" | "MD5" | "SHA1" | "SHA256";
...
export type ObjectEncryptionFilter = (_ObjectEncryptionFilter & { SSES3: SSES3Filter }) | (_ObjectEncryptionFilter & { SSEKMS: SSEKMSFilter }) | (_ObjectEncryptionFilter & { DSSEKMS: DSSEKMSFilter }) | (_ObjectEncryptionFilter & { SSEC: SSECFilter }) | (_ObjectEncryptionFilter & { NOTSSE: NotSSEFilter });
...
export type OperationName = "LambdaInvoke" | "S3PutObjectCopy" | "S3PutObjectAcl" | "S3PutObjectTagging" | "S3DeleteObjectTagging" | "S3InitiateRestoreObject" | "S3PutObjectLegalHold" | "S3PutObjectRetention" | "S3ReplicateObject" | "S3ComputeObjectChecksum";
...
export type S3ControlErrors = BadRequestException | BucketAlreadyExists | BucketAlreadyOwnedByYou | IdempotencyException | InternalServiceException | InvalidNextTokenException | InvalidRequestException | JobStatusException | NoSuchPublicAccessBlockConfiguration | NotFoundException | TooManyRequestsException | TooManyTagsException | CommonAwsError;
