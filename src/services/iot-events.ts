 ...
 * deleted.
 */export const deleteDetectorModel = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-07-27", uri: "/detector-models/{detectorModelName}", method: "DELETE", sdkId: "IoT Events", sigV4ServiceName: "iotevents", name: "IotColumboService.DeleteDetectorModel" }, DeleteDetectorModelRequest, DeleteDetectorModelResponse, [InternalFailureException, InvalidRequestException, ResourceInUseException, ResourceNotFoundException, ServiceUnavailableException, ThrottlingException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Deletes an input.
 */export const deleteInput = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-07-27", uri: "/inputs/{inputName}", method: "DELETE", sdkId: "IoT Events", sigV4ServiceName: "iotevents", name: "IotColumboService.DeleteInput" }, DeleteInputRequest, DeleteInputResponse, [InternalFailureException, InvalidRequestException, ResourceInUseException, ResourceNotFoundException, ServiceUnavailableException, ThrottlingException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const describeDetectorModelAnalysis = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-07-27", uri: "/analysis/detector-models/{analysisId}", method: "GET", sdkId: "IoT Events", sigV4ServiceName: "iotevents", name: "IotColumboService.DescribeDetectorModelAnalysis" }, DescribeDetectorModelAnalysisRequest, DescribeDetectorModelAnalysisResponse, [InternalFailureException, InvalidRequestException, ResourceNotFoundException, ServiceUnavailableException, ThrottlingException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists the tags (metadata) you have assigned to the resource.
 */export const listTagsForResource = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-07-27", uri: "/tags", method: "GET", sdkId: "IoT Events", sigV4ServiceName: "iotevents", name: "IotColumboService.ListTagsForResource" }, ListTagsForResourceRequest, ListTagsForResourceResponse, [InternalFailureException, InvalidRequestException, ResourceInUseException, ResourceNotFoundException, ThrottlingException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Performs an analysis of your detector model. For more information,
 * see Troubleshooting a detector model
 * in the *AWS IoT Events Developer Guide*.
 */export const startDetectorModelAnalysis = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-07-27", uri: "/analysis/detector-models", method: "POST", sdkId: "IoT Events", sigV4ServiceName: "iotevents", name: "IotColumboService.StartDetectorModelAnalysis" }, StartDetectorModelAnalysisRequest, StartDetectorModelAnalysisResponse, [InternalFailureException, InvalidRequestException, LimitExceededException, ServiceUnavailableException, ThrottlingException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Adds to or modifies the tags of the given resource. Tags are metadata that can be used to
 * manage a resource.
 */export const tagResource = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-07-27", uri: "/tags", method: "POST", sdkId: "IoT Events", sigV4ServiceName: "iotevents", name: "IotColumboService.TagResource" }, TagResourceRequest, TagResourceResponse, [InternalFailureException, InvalidRequestException, LimitExceededException, ResourceInUseException, ResourceNotFoundException, ThrottlingException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Removes the given tags (metadata) from the resource.
 */export const untagResource = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-07-27", uri: "/tags", method: "DELETE", sdkId: "IoT Events", sigV4ServiceName: "iotevents", name: "IotColumboService.UntagResource" }, UntagResourceRequest, UntagResourceResponse, [InternalFailureException, InvalidRequestException, ResourceInUseException, ResourceNotFoundException, ThrottlingException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const putLoggingOptions = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-07-27", uri: "/logging", method: "PUT", sdkId: "IoT Events", sigV4ServiceName: "iotevents", name: "IotColumboService.PutLoggingOptions" }, PutLoggingOptionsRequest, S.Struct({}), [InternalFailureException, InvalidRequestException, ResourceInUseException, ServiceUnavailableException, ThrottlingException, UnsupportedOperationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
