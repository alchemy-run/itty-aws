...
export declare class MailManager extends AWSServiceClient {
  ...
  deleteAddressList(
    ...
    AccessDeniedException | ConflictException | ThrottlingException | CommonAwsError
  >;
  deleteArchive(
...
export type MailManagerErrors = AccessDeniedException | ConflictException | ResourceNotFoundException | ServiceQuotaExceededException | ThrottlingException | ValidationException | CommonAwsError;
