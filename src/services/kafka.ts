 ...
 */export const tagResource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-11-14", uri: "/v1/tags/{ResourceArn}", sdkId: "Kafka", sigV4ServiceName: "kafka", name: "Kafka.TagResource" }, TagResourceRequest, S.Struct({}), [BadRequestException, InternalServerErrorException, NotFoundException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const batchAssociateScramSecret = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-11-14", uri: "/v1/clusters/{ClusterArn}/scram-secrets", sdkId: "Kafka", sigV4ServiceName: "kafka", name: "Kafka.BatchAssociateScramSecret" }, BatchAssociateScramSecretRequest, BatchAssociateScramSecretResponse, [BadRequestException, ForbiddenException, InternalServerErrorException, NotFoundException, ServiceUnavailableException, TooManyRequestsException, UnauthorizedException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const createConfiguration = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-11-14", uri: "/v1/configurations", sdkId: "Kafka", sigV4ServiceName: "kafka", name: "Kafka.CreateConfiguration" }, CreateConfigurationRequest, CreateConfigurationResponse, [BadRequestException, ConflictException, ForbiddenException, InternalServerErrorException, ServiceUnavailableException, TooManyRequestsException, UnauthorizedException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Creates a new MSK VPC connection.
 */export const createVpcConnection = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-11-14", uri: "/v1/vpc-connection", sdkId: "Kafka", sigV4ServiceName: "kafka", name: "Kafka.CreateVpcConnection" }, CreateVpcConnectionRequest, CreateVpcConnectionResponse, [BadRequestException, ForbiddenException, InternalServerErrorException, ServiceUnavailableException, TooManyRequestsException, UnauthorizedException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const createCluster = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-11-14", uri: "/v1/clusters", sdkId: "Kafka", sigV4ServiceName: "kafka", name: "Kafka.CreateCluster" }, CreateClusterRequest, CreateClusterResponse, [BadRequestException, ConflictException, ForbiddenException, InternalServerErrorException, ServiceUnavailableException, TooManyRequestsException, UnauthorizedException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Creates a new MSK cluster.
 */export const createClusterV2 = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-11-14", uri: "/api/v2/clusters", sdkId: "Kafka", sigV4ServiceName: "kafka", name: "Kafka.CreateClusterV2" }, CreateClusterV2Request, CreateClusterV2Response, [BadRequestException, ConflictException, ForbiddenException, InternalServerErrorException, ServiceUnavailableException, TooManyRequestsException, UnauthorizedException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Creates the replicator.
 */export const createReplicator = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-11-14", uri: "/replication/v1/replicators", sdkId: "Kafka", sigV4ServiceName: "kafka", name: "Kafka.CreateReplicator" }, CreateReplicatorRequest, CreateReplicatorResponse, [BadRequestException, ConflictException, ForbiddenException, InternalServerErrorException, NotFoundException, ServiceUnavailableException, TooManyRequestsException, UnauthorizedException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
