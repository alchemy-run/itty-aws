...
export type ChimeSDKMeetingsErrors = BadRequestException | ConflictException | ForbiddenException | LimitExceededException | NotFoundException | ResourceNotFoundException | ServiceFailureException | ServiceUnavailableException | ThrottlingException | TooManyTagsException | UnauthorizedException | UnprocessableEntityException | CommonAwsError;
