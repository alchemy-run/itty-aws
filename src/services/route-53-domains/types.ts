...
export type Route53DomainsErrors = DnssecLimitExceeded | DomainLimitExceeded | DuplicateRequest | InvalidInput | OperationLimitExceeded | TLDRulesViolation | UnsupportedTLD | CommonAwsError;
