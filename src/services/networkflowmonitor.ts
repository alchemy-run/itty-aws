 ...
 */export const untagResource = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-04-19", uri: "/tags/{resourceArn}", method: "DELETE", sdkId: "NetworkFlowMonitor", sigV4ServiceName: "networkflowmonitor", name: "NetworkFlowMonitor.UntagResource" }, UntagResourceInput, UntagResourceOutput, [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Returns all the tags for a resource.
 */export const listTagsForResource = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-04-19", uri: "/tags/{resourceArn}", method: "GET", sdkId: "NetworkFlowMonitor", sigV4ServiceName: "networkflowmonitor", name: "NetworkFlowMonitor.ListTagsForResource" }, ListTagsForResourceInput, ListTagsForResourceOutput, [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Adds a tag to a resource.
 */export const tagResource = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-04-19", uri: "/tags/{resourceArn}", method: "POST", sdkId: "NetworkFlowMonitor", sigV4ServiceName: "networkflowmonitor", name: "NetworkFlowMonitor.TagResource" }, TagResourceInput, TagResourceOutput, [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
