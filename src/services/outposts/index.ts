...
const metadata = {
  ...
  operations: {
    "CancelCapacityTask": "POST /outposts/{OutpostIdentifier}/capacity/{CapacityTaskId}",
    ...
    "GetCapacityTask": "GET /outposts/{OutpostIdentifier}/capacity/{CapacityTaskId}",
    ...
    "GetOutpostBillingInformation": "GET /outpost/{OutpostIdentifier}/billing-information",
    "GetOutpostInstanceTypes": "GET /outposts/{OutpostId}/instanceTypes",
    "GetOutpostSupportedInstanceTypes": "GET /outposts/{OutpostIdentifier}/supportedInstanceTypes",
    ...
    "ListBlockingInstancesForCapacityTask": "GET /outposts/{OutpostIdentifier}/capacity/{CapacityTaskId}/blockingInstances",
    ...
    "UpdateSiteRackPhysicalProperties": "PATCH /sites/{SiteId}/rackPhysicalProperties",
  },
