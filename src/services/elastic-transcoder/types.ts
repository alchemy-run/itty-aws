...
export type ElasticTranscoderErrors = AccessDeniedException | IncompatibleVersionException | InternalServiceException | LimitExceededException | ResourceInUseException | ResourceNotFoundException | ValidationException | CommonAwsError;
