...
import type { Billing as _BillingClient } from "./types.ts";
...
export type _Billing = _BillingClient;
export interface Billing extends _Billing {}
...
} as unknown as typeof _BillingClient;
