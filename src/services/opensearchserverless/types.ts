...
export type OpenSearchServerlessErrors = ConflictException | InternalServerException | OcuLimitExceededException | ResourceNotFoundException | ServiceQuotaExceededException | ValidationException | CommonAwsError;
