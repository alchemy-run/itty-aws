 ...
 */export const getResourcePermission = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/get-resource-permission", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.GetResourcePermission" }, GetResourcePermissionInput, GetResourcePermissionOutput, [InternalServerException, ResourceNotFoundException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists the configuration check operations performed by AWS Systems Manager for SAP.
 */export const listConfigurationCheckOperations = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/list-configuration-check-operations", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.ListConfigurationCheckOperations" }, ListConfigurationCheckOperationsInput, ListConfigurationCheckOperationsOutput, [InternalServerException, ResourceNotFoundException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists the operations performed by AWS Systems Manager for SAP.
 */export const listOperations = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/list-operations", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.ListOperations" }, ListOperationsInput, ListOperationsOutput, [InternalServerException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists all tags on an SAP HANA application and/or database registered with AWS Systems Manager for SAP.
 */export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/tags/{resourceArn}", method: "GET", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.ListTagsForResource" }, ListTagsForResourceRequest, ListTagsForResourceResponse, [ConflictException, ResourceNotFoundException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Adds permissions to the target database.
 */export const putResourcePermission = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/put-resource-permission", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.PutResourcePermission" }, PutResourcePermissionInput, PutResourcePermissionOutput, [InternalServerException, ResourceNotFoundException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Request is an operation which starts an application.
 * 
 * Parameter `ApplicationId` is required.
 */export const startApplication = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/start-application", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.StartApplication" }, StartApplicationInput, StartApplicationOutput, [ConflictException, InternalServerException, ResourceNotFoundException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Refreshes a registered application.
 */export const startApplicationRefresh = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/start-application-refresh", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.StartApplicationRefresh" }, StartApplicationRefreshInput, StartApplicationRefreshOutput, [ConflictException, InternalServerException, ResourceNotFoundException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Initiates configuration check operations against a specified application.
 */export const startConfigurationChecks = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/start-configuration-checks", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.StartConfigurationChecks" }, StartConfigurationChecksInput, StartConfigurationChecksOutput, [ConflictException, InternalServerException, ResourceNotFoundException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Request is an operation to stop an application.
 * 
 * Parameter `ApplicationId` is required. Parameters `StopConnectedEntity` and `IncludeEc2InstanceShutdown` are optional.
 */export const stopApplication = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/stop-application", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.StopApplication" }, StopApplicationInput, StopApplicationOutput, [ConflictException, InternalServerException, ResourceNotFoundException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Creates tag for a resource by specifying the ARN.
 */export const tagResource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/tags/{resourceArn}", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.TagResource" }, TagResourceRequest, TagResourceResponse, [ConflictException, ResourceNotFoundException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Delete the tags for a resource.
 */export const untagResource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/tags/{resourceArn}", method: "DELETE", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.UntagResource" }, UntagResourceRequest, UntagResourceResponse, [ConflictException, ResourceNotFoundException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Removes permissions associated with the target database.
 */export const deleteResourcePermission = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/delete-resource-permission", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.DeleteResourcePermission" }, DeleteResourcePermissionInput, DeleteResourcePermissionOutput, [InternalServerException, ResourceNotFoundException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const deregisterApplication = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/deregister-application", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.DeregisterApplication" }, DeregisterApplicationInput, DeregisterApplicationOutput, [InternalServerException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Gets an application registered with AWS Systems Manager for SAP. It also returns the components of the application.
 */export const getApplication = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/get-application", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.GetApplication" }, GetApplicationInput, GetApplicationOutput, [InternalServerException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Gets the SAP HANA database of an application registered with AWS Systems Manager for SAP.
 */export const getDatabase = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/get-database", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.GetDatabase" }, GetDatabaseInput, GetDatabaseOutput, [InternalServerException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists all the components registered with AWS Systems Manager for SAP.
 */export const listComponents = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/list-components", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.ListComponents" }, ListComponentsInput, ListComponentsOutput, [InternalServerException, ResourceNotFoundException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists all configuration check types supported by AWS Systems Manager for SAP.
 */export const listConfigurationCheckDefinitions = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/list-configuration-check-definitions", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.ListConfigurationCheckDefinitions" }, ListConfigurationCheckDefinitionsInput, ListConfigurationCheckDefinitionsOutput, [InternalServerException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists the SAP HANA databases of an application registered with AWS Systems Manager for SAP.
 */export const listDatabases = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/list-databases", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.ListDatabases" }, ListDatabasesInput, ListDatabasesOutput, [InternalServerException, ResourceNotFoundException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists the sub-check results of a specified configuration check operation.
 */export const listSubCheckResults = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/list-sub-check-results", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.ListSubCheckResults" }, ListSubCheckResultsInput, ListSubCheckResultsOutput, [InternalServerException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const registerApplication = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/register-application", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.RegisterApplication" }, RegisterApplicationInput, RegisterApplicationOutput, [ConflictException, InternalServerException, ResourceNotFoundException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Updates the settings of an application registered with AWS Systems Manager for SAP.
 */export const updateApplicationSettings = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/update-application-settings", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.UpdateApplicationSettings" }, UpdateApplicationSettingsInput, UpdateApplicationSettingsOutput, [ConflictException, InternalServerException, ResourceNotFoundException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Gets the details of a configuration check operation by specifying the operation ID.
 */export const getConfigurationCheckOperation = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/get-configuration-check-operation", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.GetConfigurationCheckOperation" }, GetConfigurationCheckOperationInput, GetConfigurationCheckOperationOutput, [InternalServerException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Gets the details of an operation by specifying the operation ID.
 */export const getOperation = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/get-operation", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.GetOperation" }, GetOperationInput, GetOperationOutput, [InternalServerException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists all the applications registered with AWS Systems Manager for SAP.
 */export const listApplications = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/list-applications", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.ListApplications" }, ListApplicationsInput, ListApplicationsOutput, [InternalServerException, ResourceNotFoundException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Returns a list of operations events.
 * 
 * Available parameters include `OperationID`, as well as optional parameters `MaxResults`, `NextToken`, and `Filters`.
 */export const listOperationEvents = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/list-operation-events", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.ListOperationEvents" }, ListOperationEventsInput, ListOperationEventsOutput, [InternalServerException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists the rules of a specified sub-check belonging to a configuration check operation.
 */export const listSubCheckRuleResults = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/list-sub-check-rule-results", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.ListSubCheckRuleResults" }, ListSubCheckRuleResultsInput, ListSubCheckRuleResultsOutput, [InternalServerException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Gets the component of an application registered with AWS Systems Manager for SAP.
 */export const getComponent = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-05-10", uri: "/get-component", sdkId: "Ssm Sap", sigV4ServiceName: "ssm-sap", name: "SsmSap.GetComponent" }, GetComponentInput, GetComponentOutput, [InternalServerException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
