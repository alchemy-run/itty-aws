 ...
 */export const upgradeAccountPlan = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-09-07", sdkId: "FreeTier", sigV4ServiceName: "freetier", name: "AWSFreeTierService.UpgradeAccountPlan" }, UpgradeAccountPlanRequest, UpgradeAccountPlanResponse, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatAwsJSON10Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Returns a specific activity record that is available to the customer.
 */export const getAccountActivity = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-09-07", sdkId: "FreeTier", sigV4ServiceName: "freetier", name: "AWSFreeTierService.GetAccountActivity" }, GetAccountActivityRequest, GetAccountActivityResponse, [InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatAwsJSON10Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * This returns all of the information related to the state of the account plan related to Free Tier.
 */export const getAccountPlanState = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-09-07", sdkId: "FreeTier", sigV4ServiceName: "freetier", name: "AWSFreeTierService.GetAccountPlanState" }, GetAccountPlanStateRequest, GetAccountPlanStateResponse, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatAwsJSON10Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Returns a list of activities that are available. This operation supports pagination and filtering by status.
 */export const listAccountActivities = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-09-07", sdkId: "FreeTier", sigV4ServiceName: "freetier", name: "AWSFreeTierService.ListAccountActivities" }, ListAccountActivitiesRequest, ListAccountActivitiesResponse, [InternalServerException, ThrottlingException, ValidationException]), FormatAwsJSON10Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Returns a list of all Free Tier usage objects that match your filters.
 */export const getFreeTierUsage = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-09-07", sdkId: "FreeTier", sigV4ServiceName: "freetier", name: "AWSFreeTierService.GetFreeTierUsage" }, GetFreeTierUsageRequest, GetFreeTierUsageResponse, [InternalServerException, ThrottlingException, ValidationException]), FormatAwsJSON10Request, FormatJSONResponse, FormatAwsRestJSONError);
