...
const metadata = {
  ...
  operations: {
    ...
    "GetDetectorModelAnalysisResults": "GET /analysis/detector-models/{analysisId}/results",
    ...
    "ListDetectorModelVersions": "GET /detector-models/{detectorModelName}/versions",
