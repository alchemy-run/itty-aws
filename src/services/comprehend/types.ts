...
export type ComprehendErrors = BatchSizeLimitExceededException | ConcurrentModificationException | InternalServerException | InvalidFilterException | InvalidRequestException | JobNotFoundException | KmsKeyValidationException | ResourceInUseException | ResourceLimitExceededException | ResourceNotFoundException | ResourceUnavailableException | TextSizeLimitExceededException | TooManyRequestsException | TooManyTagKeysException | TooManyTagsException | UnsupportedLanguageException | CommonAwsError;
