...
const metadata = {
  ...
  operations: {
    ...
    "GetProfileHistoryRecord": "GET /domains/{DomainName}/profiles/{ProfileId}/history-records/{Id}",
    ...
    "ListProfileHistoryRecords": "POST /domains/{DomainName}/profiles/history-records",
