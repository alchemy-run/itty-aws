...
const metadata = {
  ...
  operations: {
    ...
    "CreateDocumentationVersion": "POST /restapis/{restApiId}/documentation/versions",
    ...
    "DeleteBasePathMapping": "DELETE /domainnames/{domainName}/basepathmappings/{basePath}",
    ...
    "DeleteDocumentationPart": "DELETE /restapis/{restApiId}/documentation/parts/{documentationPartId}",
    "DeleteDocumentationVersion": "DELETE /restapis/{restApiId}/documentation/versions/{documentationVersion}",
    "DeleteDomainName": "DELETE /domainnames/{domainName}",
    "DeleteDomainNameAccessAssociation": "DELETE /domainnameaccessassociations/{domainNameAccessAssociationArn}",
    "DeleteGatewayResponse": "DELETE /restapis/{restApiId}/gatewayresponses/{responseType}",
    "DeleteIntegration": "DELETE /restapis/{restApiId}/resources/{resourceId}/methods/{httpMethod}/integration",
    "DeleteIntegrationResponse": "DELETE /restapis/{restApiId}/resources/{resourceId}/methods/{httpMethod}/integration/responses/{statusCode}",
    ...
    "DeleteRequestValidator": "DELETE /restapis/{restApiId}/requestvalidators/{requestValidatorId}",
    ...
    "FlushStageAuthorizersCache": "DELETE /restapis/{restApiId}/stages/{stageName}/cache/authorizers",
    "FlushStageCache": "DELETE /restapis/{restApiId}/stages/{stageName}/cache/data",
    ...
    "GetBasePathMapping": "GET /domainnames/{domainName}/basepathmappings/{basePath}",
    ...
    "GetDocumentationPart": "GET /restapis/{restApiId}/documentation/parts/{documentationPartId}",
    "GetDocumentationParts": "GET /restapis/{restApiId}/documentation/parts",
    "GetDocumentationVersion": "GET /restapis/{restApiId}/documentation/versions/{documentationVersion}",
    "GetDocumentationVersions": "GET /restapis/{restApiId}/documentation/versions",
    ...
    "GetGatewayResponse": "GET /restapis/{restApiId}/gatewayresponses/{responseType}",
    ...
    "GetIntegrationResponse": "GET /restapis/{restApiId}/resources/{resourceId}/methods/{httpMethod}/integration/responses/{statusCode}",
    ...
    "GetModelTemplate": "GET /restapis/{restApiId}/models/{modelName}/default_template",
    "GetRequestValidator": "GET /restapis/{restApiId}/requestvalidators/{requestValidatorId}",
    ...
    "PutGatewayResponse": "PUT /restapis/{restApiId}/gatewayresponses/{responseType}",
    ...
    "TestInvokeAuthorizer": "POST /restapis/{restApiId}/authorizers/{authorizerId}",
    "TestInvokeMethod": "POST /restapis/{restApiId}/resources/{resourceId}/methods/{httpMethod}",
    ...
    "UpdateBasePathMapping": "PATCH /domainnames/{domainName}/basepathmappings/{basePath}",
    ...
    "UpdateDocumentationPart": "PATCH /restapis/{restApiId}/documentation/parts/{documentationPartId}",
    "UpdateDocumentationVersion": "PATCH /restapis/{restApiId}/documentation/versions/{documentationVersion}",
    "UpdateDomainName": "PATCH /domainnames/{domainName}",
    "UpdateGatewayResponse": "PATCH /restapis/{restApiId}/gatewayresponses/{responseType}",
    "UpdateIntegration": "PATCH /restapis/{restApiId}/resources/{resourceId}/methods/{httpMethod}/integration",
    "UpdateIntegrationResponse": "PATCH /restapis/{restApiId}/resources/{resourceId}/methods/{httpMethod}/integration/responses/{statusCode}",
    "UpdateMethod": "PATCH /restapis/{restApiId}/resources/{resourceId}/methods/{httpMethod}",
    "UpdateMethodResponse": "PATCH /restapis/{restApiId}/resources/{resourceId}/methods/{httpMethod}/responses/{statusCode}",
    "UpdateModel": "PATCH /restapis/{restApiId}/models/{modelName}",
    "UpdateRequestValidator": "PATCH /restapis/{restApiId}/requestvalidators/{requestValidatorId}",
