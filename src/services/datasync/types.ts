...
export type EndpointType = "PUBLIC" | "PRIVATE_LINK" | "FIPS" | "FIPS_PRIVATE_LINK";
...
export type DataSyncErrors = InternalException | InvalidRequestException | CommonAwsError;
