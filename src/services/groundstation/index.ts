...
const metadata = {
  ...
  operations: {
    ...
    "DeleteDataflowEndpointGroup": "DELETE /dataflowEndpointGroup/{dataflowEndpointGroupId}",
    ...
    "GetDataflowEndpointGroup": "GET /dataflowEndpointGroup/{dataflowEndpointGroupId}",
