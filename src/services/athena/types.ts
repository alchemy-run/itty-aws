...
export type AthenaErrors = InternalServerException | InvalidRequestException | MetadataException | ResourceNotFoundException | SessionAlreadyExistsException | TooManyRequestsException | CommonAwsError;
