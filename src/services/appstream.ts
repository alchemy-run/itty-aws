 ...
 */export const expireSession = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2016-12-01", uri: "/", method: "POST", sdkId: "AppStream", sigV4ServiceName: "appstream", name: "PhotonAdminProxyService.ExpireSession" }, ExpireSessionRequest, ExpireSessionResult, []), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
