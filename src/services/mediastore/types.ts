...
export type MediaStoreErrors = ContainerInUseException | ContainerNotFoundException | CorsPolicyNotFoundException | InternalServerError | LimitExceededException | PolicyNotFoundException | CommonAwsError;
