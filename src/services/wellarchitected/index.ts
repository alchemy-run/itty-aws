...
const metadata = {
  ...
  operations: {
    ...
    "GetAnswer": "GET /workloads/{WorkloadId}/lensReviews/{LensAlias}/answers/{QuestionId}",
    ...
    "GetLensReviewReport": "GET /workloads/{WorkloadId}/lensReviews/{LensAlias}/report",
    ...
    "GetReviewTemplateAnswer": "GET /reviewTemplates/{TemplateArn}/lensReviews/{LensAlias}/answers/{QuestionId}",
    ...
    "ListLensReviewImprovements": "GET /workloads/{WorkloadId}/lensReviews/{LensAlias}/improvements",
    ...
    "ListReviewTemplateAnswers": "GET /reviewTemplates/{TemplateArn}/lensReviews/{LensAlias}/answers",
    ...
    "UpdateAnswer": "PATCH /workloads/{WorkloadId}/lensReviews/{LensAlias}/answers/{QuestionId}",
    ...
    "UpdateReviewTemplateAnswer": "PATCH /reviewTemplates/{TemplateArn}/lensReviews/{LensAlias}/answers/{QuestionId}",
    "UpdateReviewTemplateLensReview": "PATCH /reviewTemplates/{TemplateArn}/lensReviews/{LensAlias}",
    ...
    "UpgradeLensReview": "PUT /workloads/{WorkloadId}/lensReviews/{LensAlias}/upgrade",
    "UpgradeProfileVersion": "PUT /workloads/{WorkloadId}/profiles/{ProfileArn}/upgrade",
    "UpgradeReviewTemplateLensReview": "PUT /reviewTemplates/{TemplateArn}/lensReviews/{LensAlias}/upgrade",
  },
