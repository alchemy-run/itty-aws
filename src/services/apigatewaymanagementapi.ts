 ...
 */export const postToConnection = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-11-29", uri: "/@connections/{ConnectionId}", sdkId: "ApiGatewayManagementApi", sigV4ServiceName: "execute-api", name: "ApiGatewayManagementApi.PostToConnection" }, PostToConnectionRequest, S.Struct({}), [ForbiddenException, GoneException, LimitExceededException, PayloadTooLargeException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
