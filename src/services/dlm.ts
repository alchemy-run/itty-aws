 ...
 */export const untagResource = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-01-12", uri: "/tags/{ResourceArn}", method: "DELETE", sdkId: "DLM", sigV4ServiceName: "dlm", name: "dlm_20180112.UntagResource" }, UntagResourceRequest, UntagResourceResponse, [InternalServerException, InvalidRequestException, ResourceNotFoundException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 * policies.
 */export const updateLifecyclePolicy = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2018-01-12", uri: "/policies/{PolicyId}", method: "PATCH", sdkId: "DLM", sigV4ServiceName: "dlm", name: "dlm_20180112.UpdateLifecyclePolicy" }, UpdateLifecyclePolicyRequest, UpdateLifecyclePolicyResponse, [InternalServerException, InvalidRequestException, LimitExceededException, ResourceNotFoundException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
