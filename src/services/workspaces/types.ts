...
export type AssociationErrorCode = "ValidationError.InsufficientDiskSpace" | "ValidationError.InsufficientMemory" | "ValidationError.UnsupportedOperatingSystem" | "DeploymentError.InternalServerError" | "DeploymentError.WorkspaceUnreachable";
...
export type CustomWorkspaceImageImportErrorDetailsList = Array<CustomWorkspaceImageImportErrorDetails>;
export type CustomWorkspaceImageImportState = "PENDING" | "IN_PROGRESS" | "COMPLETED" | "ERROR";
...
export type ImageSourceIdentifier = (_ImageSourceIdentifier & { Ec2ImportTaskId: string }) | (_ImageSourceIdentifier & { ImageBuildVersionArn: string }) | (_ImageSourceIdentifier & { Ec2ImageId: string });
