...
export interface SendMessageBatchRequestEntry {
  ...
  DelaySeconds?: number;
  MessageAttributes?: Record<string, MessageAttributeValue>;
  MessageSystemAttributes?: { [key in MessageSystemAttributeNameForSends]?: string };
