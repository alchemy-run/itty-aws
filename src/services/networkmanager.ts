 ...
 */export const associateConnectPeer = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2019-07-05", uri: "/global-networks/{GlobalNetworkId}/connect-peer-associations", method: "POST", sdkId: "NetworkManager", sigV4ServiceName: "networkmanager", name: "NetworkManager.AssociateConnectPeer" }, AssociateConnectPeerRequest, AssociateConnectPeerResponse, [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
