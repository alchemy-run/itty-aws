...
export type AIOpsErrors = AccessDeniedException | ConflictException | ForbiddenException | InternalServerException | ResourceNotFoundException | ServiceQuotaExceededException | ThrottlingException | ValidationException | CommonAwsError;
