 ...
 */export const untagResource = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/tags/{resourceARN}", method: "DELETE", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.UntagResource" }, UntagResourceRequest, UntagResourceResponse, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Updates the verification status of a library item for an Amazon Q App.
 */export const updateLibraryItemMetadata = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/catalog.updateItemMetadata", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.UpdateLibraryItemMetadata" }, UpdateLibraryItemMetadataInput, S.Struct({}), [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Associates a rating or review for a library item with the user submitting the request. This increments the rating count for the specified library item.
 */export const associateLibraryItemReview = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/catalog.associateItemRating", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.AssociateLibraryItemReview" }, AssociateLibraryItemReviewInput, S.Struct({}), [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * This operation creates a link between the user's identity calling the operation and a specific Q App. This is useful to mark the Q App as a *favorite* for the user if the user doesn't own the Amazon Q App so they can still run it and see it in their inventory of Q Apps.
 */export const associateQAppWithUser = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/apps.install", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.AssociateQAppWithUser" }, AssociateQAppWithUserInput, S.Struct({}), [AccessDeniedException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const batchCreateCategory = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/catalog.createCategories", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.BatchCreateCategory" }, BatchCreateCategoryInput, S.Struct({}), [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const batchDeleteCategory = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/catalog.deleteCategories", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.BatchDeleteCategory" }, BatchDeleteCategoryInput, S.Struct({}), [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const batchUpdateCategory = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/catalog.updateCategories", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.BatchUpdateCategory" }, BatchUpdateCategoryInput, S.Struct({}), [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Creates a new library item for an Amazon Q App, allowing it to be discovered and used by other allowed users.
 */export const createLibraryItem = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/catalog.createItem", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.CreateLibraryItem" }, CreateLibraryItemInput, CreateLibraryItemOutput, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Deletes a library item for an Amazon Q App, removing it from the library so it can no longer be discovered or used by other users.
 */export const deleteLibraryItem = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/catalog.deleteItem", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.DeleteLibraryItem" }, DeleteLibraryItemInput, S.Struct({}), [AccessDeniedException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Deletes an Amazon Q App owned by the user. If the Q App was previously published to the library, it is also removed from the library.
 */export const deleteQApp = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/apps.delete", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.DeleteQApp" }, DeleteQAppInput, S.Struct({}), [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Removes a rating or review previously submitted by the user for a library item.
 */export const disassociateLibraryItemReview = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/catalog.disassociateItemRating", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.DisassociateLibraryItemReview" }, DisassociateLibraryItemReviewInput, S.Struct({}), [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Disassociates a Q App from a user removing the user's access to run the Q App.
 */export const disassociateQAppFromUser = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/apps.uninstall", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.DisassociateQAppFromUser" }, DisassociateQAppFromUserInput, S.Struct({}), [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Exports the collected data of a Q App data collection session.
 */export const exportQAppSessionData = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/runtime.exportQAppSessionData", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.ExportQAppSessionData" }, ExportQAppSessionDataInput, ExportQAppSessionDataOutput, [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Retrieves the current configuration of a Q App session.
 */export const getQAppSessionMetadata = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/runtime.getQAppSessionMetadata", method: "GET", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.GetQAppSessionMetadata" }, GetQAppSessionMetadataInput, GetQAppSessionMetadataOutput, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const listCategories = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/catalog.listCategories", method: "GET", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.ListCategories" }, ListCategoriesInput, ListCategoriesOutput, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists the tags associated with an Amazon Q Apps resource.
 */export const listTagsForResource = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/tags/{resourceARN}", method: "GET", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.ListTagsForResource" }, ListTagsForResourceRequest, ListTagsForResourceResponse, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Stops an active session for an Amazon Q App.This deletes all data related to the session and makes it invalid for future uses. The results of the session will be persisted as part of the conversation.
 */export const stopQAppSession = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/runtime.deleteMiniAppRun", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.StopQAppSession" }, StopQAppSessionInput, S.Struct({}), [AccessDeniedException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Associates tags with an Amazon Q Apps resource.
 */export const tagResource = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/tags/{resourceARN}", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.TagResource" }, TagResourceRequest, TagResourceResponse, [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Updates the library item for an Amazon Q App.
 */export const updateLibraryItem = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/catalog.updateItem", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.UpdateLibraryItem" }, UpdateLibraryItemInput, UpdateLibraryItemOutput, [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Updates an existing Amazon Q App, allowing modifications to its title, description, and definition.
 */export const updateQApp = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/apps.update", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.UpdateQApp" }, UpdateQAppInput, UpdateQAppOutput, [AccessDeniedException, ContentTooLargeException, InternalServerException, ResourceNotFoundException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Updates the session for a given Q App `sessionId`. This is only valid when at least one card of the session is in the `WAITING` state. Data for each `WAITING` card can be provided as input. If inputs are not provided, the call will be accepted but session will not move forward. Inputs for cards that are not in the `WAITING` status will be ignored.
 */export const updateQAppSession = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/runtime.updateQAppSession", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.UpdateQAppSession" }, UpdateQAppSessionInput, UpdateQAppSessionOutput, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const createPresignedUrl = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/apps.createPresignedUrl", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.CreatePresignedUrl" }, CreatePresignedUrlInput, CreatePresignedUrlOutput, [AccessDeniedException, InternalServerException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Retrieves details about a library item for an Amazon Q App, including its metadata, categories, ratings, and usage statistics.
 */export const getLibraryItem = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/catalog.getItem", method: "GET", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.GetLibraryItem" }, GetLibraryItemInput, GetLibraryItemOutput, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const importDocument = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/apps.importDocument", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.ImportDocument" }, ImportDocumentInput, ImportDocumentOutput, [AccessDeniedException, ContentTooLargeException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists the library items for Amazon Q Apps that are published and available for users in your Amazon Web Services account.
 */export const listLibraryItems = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/catalog.list", method: "GET", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.ListLibraryItems" }, ListLibraryItemsInput, ListLibraryItemsOutput, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists the Amazon Q Apps owned by or associated with the user either because they created it or because they used it from the library in the past. The user identity is extracted from the credentials used to invoke this operation..
 */export const listQApps = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/apps.list", method: "GET", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.ListQApps" }, ListQAppsInput, ListQAppsOutput, [AccessDeniedException, InternalServerException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Updates read permissions for a Amazon Q App in Amazon Q Business application environment instance.
 */export const updateQAppPermissions = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/apps.updateQAppPermissions", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.UpdateQAppPermissions" }, UpdateQAppPermissionsInput, UpdateQAppPermissionsOutput, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Updates the configuration metadata of a session for a given Q App `sessionId`.
 */export const updateQAppSessionMetadata = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/runtime.updateQAppSessionMetadata", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.UpdateQAppSessionMetadata" }, UpdateQAppSessionMetadataInput, UpdateQAppSessionMetadataOutput, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Describes read permissions for a Amazon Q App in Amazon Q Business application environment instance.
 */export const describeQAppPermissions = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/apps.describeQAppPermissions", method: "GET", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.DescribeQAppPermissions" }, DescribeQAppPermissionsInput, DescribeQAppPermissionsOutput, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists the collected data of a Q App data collection session.
 */export const listQAppSessionData = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/runtime.listQAppSessionData", method: "GET", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.ListQAppSessionData" }, ListQAppSessionDataInput, ListQAppSessionDataOutput, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Starts a new session for an Amazon Q App, allowing inputs to be provided and the app to be run.
 * 
 * 
 * Each Q App session will be condensed into a single conversation in the web experience.
 */export const startQAppSession = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/runtime.startQAppSession", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.StartQAppSession" }, StartQAppSessionInput, StartQAppSessionOutput, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Retrieves the full details of an Q App, including its definition specifying the cards and flow.
 */export const getQApp = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/apps.get", method: "GET", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.GetQApp" }, GetQAppInput, GetQAppOutput, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Retrieves the current state and results for an active session of an Amazon Q App.
 */export const getQAppSession = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/runtime.getQAppSession", method: "GET", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.GetQAppSession" }, GetQAppSessionInput, GetQAppSessionOutput, [AccessDeniedException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const predictQApp = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/apps.predictQApp", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.PredictQApp" }, PredictQAppInput, PredictQAppOutput, [AccessDeniedException, InternalServerException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Creates a new Amazon Q App based on the provided definition. The Q App definition specifies the cards and flow of the Q App. This operation also calculates the dependencies between the cards by inspecting the references in the prompts.
 */export const createQApp = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/apps.create", method: "POST", sdkId: "QApps", sigV4ServiceName: "qapps", name: "QAppsService.CreateQApp" }, CreateQAppInput, CreateQAppOutput, [AccessDeniedException, ConflictException, ContentTooLargeException, InternalServerException, ServiceQuotaExceededException, ThrottlingException, UnauthorizedException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
