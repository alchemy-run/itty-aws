...
export declare class ObservabilityAdmin extends AWSServiceClient {
  ...
  getTelemetryEnrichmentStatus(
    ...
    AccessDeniedException | InternalServerException | ResourceNotFoundException | TooManyRequestsException | CommonAwsError
  >;
  ...
  startTelemetryEnrichment(
    ...
    AccessDeniedException | ConflictException | InternalServerException | TooManyRequestsException | CommonAwsError
  >;
...
export type CentralizationFailureReason = "TRUSTED_ACCESS_NOT_ENABLED" | "DESTINATION_ACCOUNT_NOT_IN_ORGANIZATION" | "INTERNAL_SERVER_ERROR";
...
export type ObservabilityAdminErrors = AccessDeniedException | ConflictException | InternalServerException | ResourceNotFoundException | ServiceQuotaExceededException | TooManyRequestsException | ValidationException | CommonAwsError;
