...
const metadata = {
  ...
  operations: {
    ...
    "CreateConfigurationSetEventDestination": "POST /v2/email/configuration-sets/{ConfigurationSetName}/event-destinations",
    ...
    "CreateEmailIdentityPolicy": "POST /v2/email/identities/{EmailIdentity}/policies/{PolicyName}",
    ...
    "DeleteConfigurationSet": "DELETE /v2/email/configuration-sets/{ConfigurationSetName}",
    "DeleteConfigurationSetEventDestination": "DELETE /v2/email/configuration-sets/{ConfigurationSetName}/event-destinations/{EventDestinationName}",
    ...
    "DeleteCustomVerificationEmailTemplate": "DELETE /v2/email/custom-verification-email-templates/{TemplateName}",
    ...
    "DeleteEmailIdentityPolicy": "DELETE /v2/email/identities/{EmailIdentity}/policies/{PolicyName}",
    "DeleteEmailTemplate": "DELETE /v2/email/templates/{TemplateName}",
    "DeleteMultiRegionEndpoint": "DELETE /v2/email/multi-region-endpoints/{EndpointName}",
    ...
    "GetConfigurationSet": "GET /v2/email/configuration-sets/{ConfigurationSetName}",
    "GetConfigurationSetEventDestinations": "GET /v2/email/configuration-sets/{ConfigurationSetName}/event-destinations",
    ...
    "GetCustomVerificationEmailTemplate": "GET /v2/email/custom-verification-email-templates/{TemplateName}",
    ...
    "GetDeliverabilityTestReport": "GET /v2/email/deliverability-dashboard/test-reports/{ReportId}",
    "GetDomainDeliverabilityCampaign": "GET /v2/email/deliverability-dashboard/campaigns/{CampaignId}",
    "GetDomainStatisticsReport": "GET /v2/email/deliverability-dashboard/statistics-report/{Domain}",
    "GetEmailIdentity": "GET /v2/email/identities/{EmailIdentity}",
    "GetEmailIdentityPolicies": "GET /v2/email/identities/{EmailIdentity}/policies",
    ...
    "GetMultiRegionEndpoint": "GET /v2/email/multi-region-endpoints/{EndpointName}",
    "GetReputationEntity": "GET /v2/email/reputation/entities/{ReputationEntityType}/{ReputationEntityReference}",
    "GetSuppressedDestination": "GET /v2/email/suppression/addresses/{EmailAddress}",
    ...
    "ListDomainDeliverabilityCampaigns": "GET /v2/email/deliverability-dashboard/domains/{SubscribedDomain}/campaigns",
    ...
    "PutConfigurationSetDeliveryOptions": "PUT /v2/email/configuration-sets/{ConfigurationSetName}/delivery-options",
    "PutConfigurationSetReputationOptions": "PUT /v2/email/configuration-sets/{ConfigurationSetName}/reputation-options",
    "PutConfigurationSetSendingOptions": "PUT /v2/email/configuration-sets/{ConfigurationSetName}/sending",
    "PutConfigurationSetSuppressionOptions": "PUT /v2/email/configuration-sets/{ConfigurationSetName}/suppression-options",
    "PutConfigurationSetTrackingOptions": "PUT /v2/email/configuration-sets/{ConfigurationSetName}/tracking-options",
    "PutConfigurationSetVdmOptions": "PUT /v2/email/configuration-sets/{ConfigurationSetName}/vdm-options",
    "PutDedicatedIpInPool": "PUT /v2/email/dedicated-ips/{Ip}/pool",
    "PutDedicatedIpPoolScalingAttributes": "PUT /v2/email/dedicated-ip-pools/{PoolName}/scaling",
    ...
    "PutEmailIdentityConfigurationSetAttributes": "PUT /v2/email/identities/{EmailIdentity}/configuration-set",
    "PutEmailIdentityDkimAttributes": "PUT /v2/email/identities/{EmailIdentity}/dkim",
    "PutEmailIdentityDkimSigningAttributes": "PUT /v1/email/identities/{EmailIdentity}/dkim/signing",
    "PutEmailIdentityFeedbackAttributes": "PUT /v2/email/identities/{EmailIdentity}/feedback",
    "PutEmailIdentityMailFromAttributes": "PUT /v2/email/identities/{EmailIdentity}/mail-from",
    ...
    "UpdateConfigurationSetEventDestination": "PUT /v2/email/configuration-sets/{ConfigurationSetName}/event-destinations/{EventDestinationName}",
    "UpdateContact": "PUT /v2/email/contact-lists/{ContactListName}/contacts/{EmailAddress}",
    "UpdateContactList": "PUT /v2/email/contact-lists/{ContactListName}",
    "UpdateCustomVerificationEmailTemplate": "PUT /v2/email/custom-verification-email-templates/{TemplateName}",
    "UpdateEmailIdentityPolicy": "PUT /v2/email/identities/{EmailIdentity}/policies/{PolicyName}",
    "UpdateEmailTemplate": "PUT /v2/email/templates/{TemplateName}",
    "UpdateReputationEntityCustomerManagedStatus": "PUT /v2/email/reputation/entities/{ReputationEntityType}/{ReputationEntityReference}/customer-managed-status",
