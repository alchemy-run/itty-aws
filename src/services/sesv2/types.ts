...
export type ReputationEntityFilterKey = "ENTITY_TYPE" | "REPUTATION_IMPACT" | "SENDING_STATUS" | "ENTITY_REFERENCE_PREFIX";
...
export type SESv2Errors = AccountSuspendedException | AlreadyExistsException | BadRequestException | ConcurrentModificationException | ConflictException | InternalServiceErrorException | InvalidNextTokenException | LimitExceededException | MailFromDomainNotVerifiedException | MessageRejected | NotFoundException | SendingPausedException | TooManyRequestsException | CommonAwsError;
