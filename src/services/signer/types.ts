...
export type signerErrors = AccessDeniedException | BadRequestException | ConflictException | InternalServiceErrorException | NotFoundException | ResourceNotFoundException | ServiceLimitExceededException | ThrottlingException | TooManyRequestsException | ValidationException | CommonAwsError;
