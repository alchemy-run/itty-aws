...
export type RuleExecutionType = "CONTINUOUS" | "SNAPSHOTS" | "CONTINUOUS_AND_SNAPSHOTS";
...
export type BackupErrors = AlreadyExistsException | ConflictException | DependencyFailureException | InvalidParameterValueException | InvalidRequestException | InvalidResourceStateException | LimitExceededException | MissingParameterValueException | ResourceNotFoundException | ServiceUnavailableException | CommonAwsError;
