...
export declare class CostExplorer extends AWSServiceClient {
  ...
  getCostAndUsage(
    ...
    BillExpirationException | BillingViewHealthStatusException | DataUnavailableException | InvalidNextTokenException | LimitExceededException | RequestChangedException | ResourceNotFoundException | CommonAwsError
  >;
  getCostAndUsageComparisons(
    input: GetCostAndUsageComparisonsRequest,
  ): Effect.Effect<
    GetCostAndUsageComparisonsResponse,
    BillingViewHealthStatusException | DataUnavailableException | InvalidNextTokenException | LimitExceededException | ResourceNotFoundException | CommonAwsError
  >;
  ...
  getCostForecast(
    ...
    BillingViewHealthStatusException | DataUnavailableException | LimitExceededException | ResourceNotFoundException | CommonAwsError
  >;
  getDimensionValues(
  ...
  getUsageForecast(
    ...
    BillingViewHealthStatusException | DataUnavailableException | LimitExceededException | ResourceNotFoundException | UnresolvableUsageUnitException | CommonAwsError
  >;
