 ...
 */export const deleteCertificateAuthority = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.DeleteCertificateAuthority" }, DeleteCertificateAuthorityRequest, S.Struct({}), [ConcurrentModificationException, InvalidArnException, InvalidStateException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const deletePermission = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.DeletePermission" }, DeletePermissionRequest, S.Struct({}), [InvalidArnException, InvalidStateException, RequestFailedException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const deletePolicy = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.DeletePolicy" }, DeletePolicyRequest, S.Struct({}), [ConcurrentModificationException, InvalidArnException, InvalidStateException, LockoutPreventedException, RequestFailedException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists information about a specific audit report created by calling the CreateCertificateAuthorityAuditReport action. Audit information is created every time the certificate authority (CA) private key is used. The private key is used when you call the IssueCertificate action or the RevokeCertificate action.
 */export const describeCertificateAuthorityAuditReport = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.DescribeCertificateAuthorityAuditReport" }, DescribeCertificateAuthorityAuditReportRequest, DescribeCertificateAuthorityAuditReportResponse, [InvalidArgsException, InvalidArnException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Retrieves the certificate and certificate chain for your private certificate authority (CA) or one that has been shared with you. Both the certificate and the chain are base64 PEM-encoded. The chain does not include the CA certificate. Each certificate in the chain signs the one before it.
 */export const getCertificateAuthorityCertificate = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.GetCertificateAuthorityCertificate" }, GetCertificateAuthorityCertificateRequest, GetCertificateAuthorityCertificateResponse, [InvalidArnException, InvalidStateException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 * 
 * - Updates made in Amazon Web Services Resource Manager (RAM) are reflected in policies. For more information, see Attach a Policy for Cross-Account Access.
 */export const getPolicy = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.GetPolicy" }, GetPolicyRequest, GetPolicyResponse, [InvalidArnException, InvalidStateException, RequestFailedException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists the tags, if any, that are associated with your private CA or one that has been shared with you. Tags are labels that you can use to identify and organize your CAs. Each tag consists of a key and an optional value. Call the TagCertificateAuthority action to add one or more tags to your CA. Call the UntagCertificateAuthority action to remove tags.
 */export const listTags = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.ListTags" }, ListTagsRequest, ListTagsResponse, [InvalidArnException, InvalidStateException, RequestFailedException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 * 
 * - Updates made in Amazon Web Services Resource Manager (RAM) are reflected in policies. For more information, see Attach a Policy for Cross-Account Access.
 */export const putPolicy = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.PutPolicy" }, PutPolicyRequest, S.Struct({}), [ConcurrentModificationException, InvalidArnException, InvalidPolicyException, InvalidStateException, LockoutPreventedException, RequestFailedException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const restoreCertificateAuthority = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.RestoreCertificateAuthority" }, RestoreCertificateAuthorityRequest, S.Struct({}), [InvalidArnException, InvalidStateException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const createCertificateAuthorityAuditReport = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.CreateCertificateAuthorityAuditReport" }, CreateCertificateAuthorityAuditReportRequest, CreateCertificateAuthorityAuditReportResponse, [InvalidArgsException, InvalidArnException, InvalidStateException, RequestFailedException, RequestInProgressException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const describeCertificateAuthority = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.DescribeCertificateAuthority" }, DescribeCertificateAuthorityRequest, DescribeCertificateAuthorityResponse, [InvalidArnException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const getCertificate = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.GetCertificate" }, GetCertificateRequest, GetCertificateResponse, [InvalidArnException, InvalidStateException, RequestFailedException, RequestInProgressException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const importCertificateAuthorityCertificate = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.ImportCertificateAuthorityCertificate" }, ImportCertificateAuthorityCertificateRequest, S.Struct({}), [CertificateMismatchException, ConcurrentModificationException, InvalidArnException, InvalidRequestException, InvalidStateException, MalformedCertificateException, RequestFailedException, RequestInProgressException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Lists the private certificate authorities that you created by using the CreateCertificateAuthority action.
 */export const listCertificateAuthorities = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.ListCertificateAuthorities" }, ListCertificateAuthoritiesRequest, ListCertificateAuthoritiesResponse, [InvalidNextTokenException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 * 
 * - If the private CA and the ACM certificates reside in different accounts, then permissions cannot be used to enable automatic renewals. Instead, the ACM certificate owner must set up a resource-based policy to enable cross-account issuance and renewals. For more information, see Using a Resource Based Policy with Amazon Web Services Private CA.
 */export const listPermissions = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.ListPermissions" }, ListPermissionsRequest, ListPermissionsResponse, [InvalidArnException, InvalidNextTokenException, InvalidStateException, RequestFailedException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const revokeCertificate = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.RevokeCertificate" }, RevokeCertificateRequest, S.Struct({}), [ConcurrentModificationException, InvalidArnException, InvalidRequestException, InvalidStateException, LimitExceededException, RequestAlreadyProcessedException, RequestFailedException, RequestInProgressException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const tagCertificateAuthority = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.TagCertificateAuthority" }, TagCertificateAuthorityRequest, S.Struct({}), [InvalidArnException, InvalidStateException, InvalidTagException, ResourceNotFoundException, TooManyTagsException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 * 
 * - If the private CA and the ACM certificates reside in different accounts, then permissions cannot be used to enable automatic renewals. Instead, the ACM certificate owner must set up a resource-based policy to enable cross-account issuance and renewals. For more information, see Using a Resource Based Policy with Amazon Web Services Private CA.
 */export const createPermission = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.CreatePermission" }, CreatePermissionRequest, S.Struct({}), [InvalidArnException, InvalidStateException, LimitExceededException, PermissionAlreadyExistsException, RequestFailedException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const issueCertificate = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2017-08-22", uri: "/", method: "POST", sdkId: "ACM PCA", sigV4ServiceName: "acm-pca", name: "ACMPrivateCA.IssueCertificate" }, IssueCertificateRequest, IssueCertificateResponse, [InvalidArgsException, InvalidArnException, InvalidStateException, LimitExceededException, MalformedCSRException, ResourceNotFoundException]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
