...
import { metadata as protocolMetadata } from "../../awsquery-metadata/rds.ts";
import type { RDS as _RDSClient } from "./types.ts";
...
export type _RDS = _RDSClient;
export interface RDS extends _RDS {}
...
} as unknown as typeof _RDSClient;
