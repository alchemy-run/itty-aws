...
export type ChangeRequestStatus = "PENDING" | "APPROVED" | "CANCELLED" | "DENIED" | "COMMITTED";
interface _ChangeSpecification {
  member?: MemberChangeSpecification;
}

export type ChangeSpecification = (_ChangeSpecification & { member: MemberChangeSpecification });
...
export type CollaborationChangeRequestSummaryList = Array<CollaborationChangeRequestSummary>;
...
export type PrivacyBudget = (_PrivacyBudget & { differentialPrivacy: DifferentialPrivacyPrivacyBudget }) | (_PrivacyBudget & { accessBudget: AccessBudget });
...
export type PrivacyBudgetTemplateParametersInput = (_PrivacyBudgetTemplateParametersInput & { differentialPrivacy: DifferentialPrivacyTemplateParametersInput }) | (_PrivacyBudgetTemplateParametersInput & { accessBudget: AccessBudgetsPrivacyTemplateParametersInput });
...
export type PrivacyBudgetTemplateParametersOutput = (_PrivacyBudgetTemplateParametersOutput & { differentialPrivacy: DifferentialPrivacyTemplateParametersOutput }) | (_PrivacyBudgetTemplateParametersOutput & { accessBudget: AccessBudgetsPrivacyTemplateParametersOutput });
...
export type ProtectedJobComputeConfiguration = (_ProtectedJobComputeConfiguration & { worker: ProtectedJobWorkerComputeConfiguration });
...
export type WorkerComputeConfigurationProperties = (_WorkerComputeConfigurationProperties & { spark: Record<string, string> });
...
export type CleanRoomsErrors = AccessDeniedException | ConflictException | InternalServerException | ResourceNotFoundException | ServiceQuotaExceededException | ThrottlingException | ValidationException | CommonAwsError;
