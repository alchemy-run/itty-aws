 ...
 */export const tagResource = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2020-01-01", uri: "/tags/{resourceArn}", method: "POST", sdkId: "Macie2", sigV4ServiceName: "macie2", name: "Macie2.TagResource" }, TagResourceRequest, TagResourceResponse, []), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
