...
export type TranslateErrors = ConcurrentModificationException | ConflictException | DetectedLanguageLowConfidenceException | InternalServerException | InvalidFilterException | InvalidParameterValueException | InvalidRequestException | LimitExceededException | ResourceNotFoundException | ServiceUnavailableException | TextSizeLimitExceededException | TooManyRequestsException | TooManyTagsException | UnsupportedDisplayLanguageCodeException | UnsupportedLanguagePairException | CommonAwsError;
