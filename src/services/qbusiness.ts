 ...
 */export const putFeedback = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/applications/{applicationId}/conversations/{conversationId}/messages/{messageId}/feedback", method: "POST", sdkId: "QBusiness", sigV4ServiceName: "qbusiness", name: "ExpertQ.PutFeedback" }, PutFeedbackRequest, S.Struct({}), [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Starts a data source connector synchronization job. If a synchronization job is already in progress, Amazon Q Business returns a `ConflictException`.
 */export const startDataSourceSyncJob = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/applications/{applicationId}/indices/{indexId}/datasources/{dataSourceId}/startsync", method: "POST", sdkId: "QBusiness", sigV4ServiceName: "qbusiness", name: "ExpertQ.StartDataSourceSyncJob" }, StartDataSourceSyncJobRequest, StartDataSourceSyncJobResponse, [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 */export const batchDeleteDocument = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/applications/{applicationId}/indices/{indexId}/documents/delete", method: "POST", sdkId: "QBusiness", sigV4ServiceName: "qbusiness", name: "ExpertQ.BatchDeleteDocument" }, BatchDeleteDocumentRequest, BatchDeleteDocumentResponse, [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 ...
 * 
 * You can see the progress of the deletion, and any error messages related to the process, by using CloudWatch.
 */export const batchPutDocument = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/applications/{applicationId}/indices/{indexId}/documents", method: "POST", sdkId: "QBusiness", sigV4ServiceName: "qbusiness", name: "ExpertQ.BatchPutDocument" }, BatchPutDocumentRequest, BatchPutDocumentResponse, [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
 * Starts or continues a streaming Amazon Q Business conversation.
 */export const chat = /*@__PURE__*/ /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2023-11-27", uri: "/applications/{applicationId}/conversations", method: "POST", sdkId: "QBusiness", sigV4ServiceName: "qbusiness", name: "ExpertQ.Chat" }, ChatInput, ChatOutput, [AccessDeniedException, ConflictException, ExternalResourceException, InternalServerException, LicenseNotFoundException, ResourceNotFoundException, ThrottlingException, ValidationException]), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
/**
