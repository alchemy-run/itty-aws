...
export type TelephonyOutboundMode = (_TelephonyOutboundMode & { progressive: ProgressiveConfig }) | (_TelephonyOutboundMode & { predictive: PredictiveConfig }) | (_TelephonyOutboundMode & { agentless: AgentlessConfig }) | (_TelephonyOutboundMode & { preview: PreviewConfig });
...
export type ConnectCampaignsV2Errors = AccessDeniedException | ConflictException | InternalServerException | InvalidCampaignStateException | InvalidStateException | ResourceNotFoundException | ServiceQuotaExceededException | ThrottlingException | ValidationException | CommonAwsError;
