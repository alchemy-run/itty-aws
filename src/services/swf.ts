 ...
 * For details and example IAM policies, see Using IAM to Manage Access to Amazon SWF
 * Workflows in the *Amazon SWF Developer Guide*.
 */export const listDomains = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2012-01-25", uri: "/", method: "POST", sdkId: "SWF", sigV4ServiceName: "swf", name: "SimpleWorkflowService.ListDomains" }, ListDomainsInput, DomainInfos, [OperationNotPermittedFault]), FormatAwsJSON10Request, FormatJSONResponse, FormatAwsRestJSONError);
/**
