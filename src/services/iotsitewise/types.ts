...
export type InterfaceRelationshipSummaries = Array<InterfaceRelationshipSummary>;
...
export type IoTSiteWiseErrors = AccessDeniedException | ConflictingOperationException | InternalFailureException | InvalidRequestException | LimitExceededException | PreconditionFailedException | QueryTimeoutException | ResourceAlreadyExistsException | ResourceNotFoundException | ServiceUnavailableException | ThrottlingException | TooManyTagsException | UnauthorizedException | ValidationException | CommonAwsError;
