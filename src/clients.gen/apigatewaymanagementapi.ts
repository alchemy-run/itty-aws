...
export const DeleteConnection = /*#__PURE__*/ makeOperation(() => Operation({ uri: "/@connections/{ConnectionId}", method: "DELETE", sdkId: "ApiGatewayManagementApi", sigV4ServiceName: "execute-api", name: "ApiGatewayManagementApi.DeleteConnection" }, DeleteConnectionRequest, Schema.Struct({}), Schema.Union(ErrorAnnotation("ForbiddenException", ForbiddenException), ErrorAnnotation("GoneException", GoneException), ErrorAnnotation("LimitExceededException", LimitExceededException))), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
...
export const GetConnection = /*#__PURE__*/ makeOperation(() => Operation({ uri: "/@connections/{ConnectionId}", method: "GET", sdkId: "ApiGatewayManagementApi", sigV4ServiceName: "execute-api", name: "ApiGatewayManagementApi.GetConnection" }, GetConnectionRequest, GetConnectionResponse, Schema.Union(ErrorAnnotation("ForbiddenException", ForbiddenException), ErrorAnnotation("GoneException", GoneException), ErrorAnnotation("LimitExceededException", LimitExceededException))), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
