...
export class LoopFlowNodeConfiguration extends S.Class<LoopFlowNodeConfiguration>("LoopFlowNodeConfiguration")({definition: S.suspend((): S.Schema<FlowDefinition> => FlowDefinition)}) {}
...
export const FlowNodeConfiguration = S.Union(InputFlowNodeConfiguration, OutputFlowNodeConfiguration, KnowledgeBaseFlowNodeConfiguration, ConditionFlowNodeConfiguration, LexFlowNodeConfiguration, PromptFlowNodeConfiguration, LambdaFunctionFlowNodeConfiguration, StorageFlowNodeConfiguration, AgentFlowNodeConfiguration, RetrievalFlowNodeConfiguration, IteratorFlowNodeConfiguration, CollectorFlowNodeConfiguration, InlineCodeFlowNodeConfiguration, S.suspend((): S.Schema<LoopFlowNodeConfiguration> => LoopFlowNodeConfiguration), LoopInputFlowNodeConfiguration, LoopControllerFlowNodeConfiguration) as any as S.Schema<FlowNodeConfiguration>;
...
export const FlowNodes = S.Array(S.suspend((): S.Schema<FlowNode> => FlowNode)) as any as S.Schema<FlowNodes>;
