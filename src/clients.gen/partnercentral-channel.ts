...
export class AccessDeniedException extends Schema.Class<AccessDeniedException>("AccessDeniedException")({message: Schema.String, reason: Schema.optional(Schema.String)}) {}
...
export class ValidationExceptionField extends Schema.Class<ValidationExceptionField>("ValidationExceptionField")({name: Schema.String, code: Schema.String, message: Schema.String}) {}
