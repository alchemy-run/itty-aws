...
export const putBucketPolicy = /*@__PURE__*/ makeOperation<void, void, CommonAwsError, typeof S3ClientRequirement>({ method: "PUT", uri: "/{Bucket}?policy", body: {"Bucket":["p","Bucket"],"ContentMD5":["Content-MD5"],"ChecksumAlgorithm":["x-amz-sdk-checksum-algorithm"],"Policy":["b","Policy"]} }, S3ClientRequirement)
