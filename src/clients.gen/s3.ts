...
export const AbortMultipartUpload = /*#__PURE__*/ makeOperation(
  () =>
    Operation(
      ...
      Error("NoSuchUpload", Schema.Struct({})),
    ),
  FormatXMLRequest,
  FormatXMLResponse,
  FormatXMLResponse,
...
export const CopyObject = /*#__PURE__*/ makeOperation(
  () =>
    Operation(
      ...
      Error("ObjectNotInActiveTierError", Schema.Struct({})),
    ),
  FormatXMLRequest,
  FormatXMLResponse,
  FormatXMLResponse,
...
export const CreateSession = /*#__PURE__*/ makeOperation(
  () =>
    Operation(
      ...
      Error("NoSuchBucket", Schema.Struct({})),
    ),
  FormatXMLRequest,
  FormatXMLResponse,
  FormatXMLResponse,
...
export const RenameObject = /*#__PURE__*/ makeOperation(
  () =>
    Operation(
      ...
      Schema.Struct({}),
      Error("IdempotencyParameterMismatch", Schema.Struct({})),
    ),
  FormatXMLRequest,
  FormatXMLResponse,
  FormatXMLResponse,
...
export const RestoreObject = /*#__PURE__*/ makeOperation(
  () =>
    Operation(
      ...
      Error("ObjectAlreadyInActiveTierError", Schema.Struct({})),
    ),
  FormatXMLRequest,
  FormatXMLResponse,
  FormatXMLResponse,
