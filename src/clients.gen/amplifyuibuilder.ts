...
export const RefreshToken = /*#__PURE__*/ makeOperation(() => Operation({ uri: "/tokens/{provider}/refresh", method: "POST", sdkId: "AmplifyUIBuilder", sigV4ServiceName: "amplifyuibuilder", name: "AmplifyUIBuilder.RefreshToken" }, RefreshTokenRequest, RefreshTokenResponse, ErrorAnnotation("InvalidParameterException", InvalidParameterException)), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
