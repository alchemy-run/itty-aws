...
export const ListChangeSets = /*#__PURE__*/ makeOperation(() => Operation({ version: "2018-09-17", uri: "/ListChangeSets", method: "POST", sdkId: "Marketplace Catalog", sigV4ServiceName: "aws-marketplace", name: "AWSMPSeymour.ListChangeSets" }, ListChangeSetsRequest, ListChangeSetsResponse, Schema.Union(ErrorAnnotation("AccessDeniedException", AccessDeniedException), ErrorAnnotation("InternalServiceException", InternalServiceException), ErrorAnnotation("ThrottlingException", ThrottlingException), ErrorAnnotation("ValidationException", ValidationException))), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
