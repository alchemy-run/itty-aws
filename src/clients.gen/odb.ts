...
export class ServiceQuotaExceededException extends S.Class<ServiceQuotaExceededException>("ServiceQuotaExceededException")({message: S.String, resourceId: S.String, resourceType: S.String, quotaCode: S.String}) {}
...
export const untagResource = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2024-08-20", uri: "/", method: "POST", sdkId: "odb", sigV4ServiceName: "odb", name: "Odb.UntagResource" }, UntagResourceRequest, UntagResourceResponse, [ResourceNotFoundExceptionError]), FormatAwsJSON10Request, FormatJSONResponse, FormatAwsRestJSONError);
