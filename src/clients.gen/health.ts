...
export class InvalidPaginationToken extends S.Class<InvalidPaginationToken>("InvalidPaginationToken")({message: S.optional(S.String)}) {}
...
export class UnsupportedLocale extends S.Class<UnsupportedLocale>("UnsupportedLocale")({message: S.optional(S.String)}) {}
...
export class InvalidPaginationTokenError extends S.TaggedError<InvalidPaginationTokenError>()("InvalidPaginationToken", InvalidPaginationToken.fields) {};
export class UnsupportedLocaleError extends S.TaggedError<UnsupportedLocaleError>()("UnsupportedLocale", UnsupportedLocale.fields) {};

//# Operations
export const enableHealthServiceAccessForOrganization = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2016-08-04", uri: "/", method: "POST", sdkId: "Health", sigV4ServiceName: "health", name: "AWSHealth_20160804.EnableHealthServiceAccessForOrganization" }, S.Struct({}), S.Struct({}), [ConcurrentModificationExceptionError]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
...
export const disableHealthServiceAccessForOrganization = /*#__PURE__*/ makeOperation(() => H.Operation({ version: "2016-08-04", uri: "/", method: "POST", sdkId: "Health", sigV4ServiceName: "health", name: "AWSHealth_20160804.DisableHealthServiceAccessForOrganization" }, S.Struct({}), S.Struct({}), [ConcurrentModificationExceptionError]), FormatAwsJSON11Request, FormatJSONResponse, FormatAwsRestJSONError);
