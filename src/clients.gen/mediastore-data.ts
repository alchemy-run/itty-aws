...
//# Schemas
export const DeleteObjectRequest = Schema.Struct({Path: Schema.String});
export const DeleteObjectResponse = Schema.Struct({});
export const DescribeObjectRequest = Schema.Struct({Path: Schema.String});
export const GetObjectRequest = Schema.Struct({Path: Schema.String, Range: Schema.optional(Header("Range"))});
export const ListItemsRequest = Schema.Struct({Path: Schema.optional(Schema.String), MaxResults: Schema.optional(Schema.Number), NextToken: Schema.optional(Schema.String)});
export const PutObjectRequest = Schema.Struct({Body: Body("undefined", StreamBody()), Path: Schema.String, ContentType: Schema.optional(Header("Content-Type")), CacheControl: Schema.optional(Header("Cache-Control")), StorageClass: Schema.optional(Header("x-amz-storage-class")), UploadAvailability: Schema.optional(Header("x-amz-upload-availability"))});
export const ContainerNotFoundException = Schema.Struct({Message: Schema.optional(Schema.String)});
export const DescribeObjectResponse = Schema.Struct({ETag: Schema.optional(Header("ETag")), ContentType: Schema.optional(Header("Content-Type")), ContentLength: Schema.optional(Header("Content-Length", Schema.Number)), CacheControl: Schema.optional(Header("Cache-Control")), LastModified: Schema.optional(Header("Last-Modified", Schema.Date))});
export const GetObjectResponse = Schema.Struct({Body: Schema.optional(Body("undefined", StreamBody())), CacheControl: Schema.optional(Header("Cache-Control")), ContentRange: Schema.optional(Header("Content-Range")), ContentLength: Schema.optional(Header("Content-Length", Schema.Number)), ContentType: Schema.optional(Header("Content-Type")), ETag: Schema.optional(Header("ETag")), LastModified: Schema.optional(Header("Last-Modified", Schema.Date)), StatusCode: Schema.Number});
export const PutObjectResponse = Schema.Struct({ContentSHA256: Schema.optional(Schema.String), ETag: Schema.optional(Schema.String), StorageClass: Schema.optional(Schema.String)});
export const Item = Schema.Struct({Name: Schema.optional(Schema.String), Type: Schema.optional(Schema.String), ETag: Schema.optional(Schema.String), LastModified: Schema.optional(Schema.Date), ContentType: Schema.optional(Schema.String), ContentLength: Schema.optional(Schema.Number)});
...
export const RequestedRangeNotSatisfiableException = Schema.Struct({Message: Schema.optional(Schema.String)});
export const ListItemsResponse = Schema.Struct({Items: Schema.optional(ItemList), NextToken: Schema.optional(Schema.String)});
...
export class RequestedRangeNotSatisfiableExceptionError extends Schema.TaggedError<RequestedRangeNotSatisfiableExceptionError>()("RequestedRangeNotSatisfiableException", RequestedRangeNotSatisfiableException) {};
