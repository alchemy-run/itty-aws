...
export const BatchGetMetrics = /*#__PURE__*/ makeOperation(() => Operation({ uri: "/BatchGetMetrics", method: "POST", sdkId: "SageMaker Metrics", sigV4ServiceName: "sagemaker", name: "SageMakerMetricsService.BatchGetMetrics" }, BatchGetMetricsRequest, BatchGetMetricsResponse, Schema.Void), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
export const BatchPutMetrics = /*#__PURE__*/ makeOperation(() => Operation({ uri: "/BatchPutMetrics", method: "PUT", sdkId: "SageMaker Metrics", sigV4ServiceName: "sagemaker", name: "SageMakerMetricsService.BatchPutMetrics" }, BatchPutMetricsRequest, BatchPutMetricsResponse, Schema.Void), FormatJSONRequest, FormatJSONResponse, FormatAwsRestJSONError);
